...
public class ti extends ListView {
    public boolean a;
    th b;
    ...
    */
    public final boolean a(android.view.MotionEvent r18, int r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ti.a(android.view.MotionEvent, int):boolean");
    }
    ...
    public boolean onHoverEvent(MotionEvent motionEvent) {
        ...
        if (pointToPosition != -1 && pointToPosition != getSelectedItemPosition()) {
            ...
            if (childAt.isEnabled()) {
                requestFocus();
                if (Build.VERSION.SDK_INT < 30 || !te.d) {
                    ...
                    try {
                        ...
                        te.b.invoke(this, valueOf);
                        te.c.invoke(this, valueOf);
    ...
    public final void setSelector(Drawable drawable) {
        tf tfVar = drawable != null ? new tf(drawable) : null;
        this.i = tfVar;
        super.setSelector(tfVar);
        Rect rect = new Rect();
        if (drawable != null) {
