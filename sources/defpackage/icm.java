...
public final class icm {
    ...
    public static final void b(float[] fArr, iah iahVar) {
        float f = fArr[0];
        float f2 = fArr[1];
        float f3 = fArr[3];
        float f4 = fArr[4];
        ...
        float f15 = iahVar.c;
        float f16 = iahVar.d;
        int floatToRawIntBits = Float.floatToRawIntBits(f14) & Alert.DURATION_SHOW_INDEFINITELY;
        float f17 = f * f10;
        float f18 = f4 * f12;
        ...
        int floatToRawIntBits2 = Float.floatToRawIntBits(f24) & Alert.DURATION_SHOW_INDEFINITELY;
        float f25 = f4 * f16;
        ...
        int floatToRawIntBits3 = Float.floatToRawIntBits(f30) & Alert.DURATION_SHOW_INDEFINITELY;
        float f31 = f * f15;
        float f32 = f31 + f18 + f7;
        float f33 = f15 * f2;
        float f34 = f21 + f33 + f8;
        float f35 = 1.0f / ((f29 + f23) + f9);
        int floatToRawIntBits4 = Float.floatToRawIntBits(f35) & Alert.DURATION_SHOW_INDEFINITELY;
        ...
        float f40 = f35 * f36;
        float min = Math.min(f38, Math.min(f39, f40));
        if (floatToRawIntBits >= 2139095040) {
            f14 = 0.0f;
        }
        float f41 = f14 * f19;
        iahVar.a = Math.min(f41, min);
        float f42 = f30 * f34;
        float f43 = f35 * f37;
        float f44 = f24 * f28;
        float f45 = f14 * f22;
        iahVar.b = Math.min(f45, Math.min(f44, Math.min(f42, f43)));
        iahVar.c = Math.max(f41, Math.max(f38, Math.max(f39, f40)));
        iahVar.d = Math.max(f45, Math.max(f44, Math.max(f42, f43)));
    }
    ...
    public final boolean equals(Object obj) {
        return (obj instanceof icm) && ffkj.e(this.a, ((icm) obj).a);
    }
