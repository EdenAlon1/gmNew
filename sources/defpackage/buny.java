...
public final class buny extends dtyq<bunm, buny, bunz, bums, bunl> {
    public buny(dtza dtzaVar) {
        super(dtzaVar);
    }
    ...
    public final /* synthetic */ dtsu a(dtve dtveVar, Cursor cursor, String[] strArr, dtzj[] dtzjVarArr, dtyo dtyoVar, dtvs dtvsVar) {
        return new bunt(dtveVar, cursor, strArr, dtzjVarArr, dtyoVar, dtvsVar, this);
    }
