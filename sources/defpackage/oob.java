...
final class oob {
    ...
    public static final Preference a(XmlPullParser xmlPullParser, PreferenceGroup preferenceGroup, Context context, Object[] objArr, oof oofVar, String[] strArr) {
        Throwable th;
        Object[] objArr2;
            ...
            try {
                try {
                    ...
                    do {
                        ...
                        try {
                            if (next == 2) {
                                PreferenceGroup preferenceGroup4 = (PreferenceGroup) d(xmlPullParser.getName(), asAttributeSet, context, objArr, strArr);
                                if (preferenceGroup == null) {
                                    preferenceGroup4.C(oofVar);
                                ...
                                xmlPullParser2 = xmlPullParser;
                                try {
                                    b(xmlPullParser2, preferenceGroup2, asAttributeSet, context, objArr, oofVar, strArr);
    ...
    private static final void b(XmlPullParser xmlPullParser, Preference preference, AttributeSet attributeSet, Context context, Object[] objArr, oof oofVar, String[] strArr) {
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if ("intent".equals(name)) {
                    ...
                    b(xmlPullParser, d, attributeSet, context, objArr, oofVar, strArr);
                }
            }
        }
    }
            ...
            try {
                try {
                    ...
                    if (strArr != null) {
                        ...
                        if (cls == null) {
                            if (e == null) {
                                throw new InflateException(a.l(str, attributeSet, ": Error inflating class "));
                            }
                            throw e;
                        }
                    } else {
                ...
                InflateException inflateException = new InflateException(a.l(str, attributeSet, ": Error inflating class "));
    ...
    private static final Preference d(String str, AttributeSet attributeSet, Context context, Object[] objArr, String[] strArr) {
        try {
            ...
            InflateException inflateException = new InflateException(a.l(str, attributeSet, ": Error inflating class (not found)"));
            inflateException.initCause(e2);
            throw inflateException;
        } catch (Exception e3) {
            InflateException inflateException2 = new InflateException(a.l(str, attributeSet, ": Error inflating class "));
