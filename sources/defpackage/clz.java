...
public final class clz extends Drawable {
    public float a;
    public float b;
    ...
    public clz(ColorStateList colorStateList, float f) {
        this.a = f;
        a(colorStateList);
        this.g = new RectF();
        this.h = new Rect();
    ...
    public final void b(Rect rect) {
        ...
        this.h.set(rect);
        if (this.c) {
            this.h.inset((int) Math.ceil(cma.a(this.b, this.a, this.d)), (int) Math.ceil(cma.b(this.b, this.a, this.d)));
            this.g.set(this.h);
        }
    }
