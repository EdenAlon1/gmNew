...
final class qt implements wv {
    ...
    public static final ColorStateList b(Context context, int i) {
        int b = yo.b(context, R.attr.colorControlHighlight);
        return new ColorStateList(new int[][]{yo.a, yo.c, yo.b, yo.e}, new int[]{yo.a(context, R.attr.colorButtonNormal), kps.g(b, i), kps.g(b, i), i});
    }

    public static final LayerDrawable c(ww wwVar, Context context, int i) {
        BitmapDrawable bitmapDrawable;
        BitmapDrawable bitmapDrawable2;
        BitmapDrawable bitmapDrawable3;
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(i);
        Drawable c = wwVar.c(context, R.drawable.abc_star_black_48dp);
        Drawable c2 = wwVar.c(context, R.drawable.abc_star_half_black_48dp);
    ...
    public static final void d(Drawable drawable, int i, PorterDuff.Mode mode) {
        ...
        mutate.setColorFilter(qu.b(i, mode));
    }
}
