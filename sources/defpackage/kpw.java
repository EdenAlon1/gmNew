...
public final class kpw {
    ...
    public static void a(kpv[] kpvVarArr, Path path) {
        int i;
        float[] fArr;
        int i2;
        kpv kpvVar;
        ...
        float f13;
        float f14;
        kpv[] kpvVarArr2 = kpvVarArr;
        Path path2 = path;
        float[] fArr2 = new float[6];
        int length = kpvVarArr2.length;
        int i5 = 0;
        int i6 = 0;
        char c2 = 'm';
        while (i6 < length) {
            kpv kpvVar3 = kpvVarArr2[i6];
            char c3 = kpvVar3.a;
            float[] fArr3 = kpvVar3.b;
            float f15 = fArr2[i5];
            float f16 = fArr2[1];
            float f17 = fArr2[2];
            float f18 = fArr2[3];
            ...
            while (i8 < fArr3.length) {
                if (c3 == 'A') {
                    ...
                    kpv.a(path, f25, f26, f27, f28, f29, f, f31, z, fArr[i4] != 0.0f ? 1 : i7);
                    f17 = fArr[i10];
                    f2 = fArr[i9];
                    f18 = f2;
                    f3 = f17;
                    ...
                    kpvVar = kpvVar2;
                    kpv.a(path, f7, f5, f47, f48, f49, f4, f6, z2, z3);
                    f3 = f7 + fArr[i38];
                    f2 = f5 + fArr[i37];
                    f17 = f3;
                    f18 = f2;
    ...
    */
    public static defpackage.kpv[] b(java.lang.String r17) {
        /*
            Method dump skipped, instructions count: 258
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.kpw.b(java.lang.String):kpv[]");
    }

    public static kpv[] c(kpv[] kpvVarArr) {
        kpv[] kpvVarArr2 = new kpv[kpvVarArr.length];
        for (int i = 0; i < kpvVarArr.length; i++) {
            kpvVarArr2[i] = new kpv(kpvVarArr[i]);
        }
        return kpvVarArr2;
    }
