...
class tei implements Function {
    public static int a(csgg csggVar) {
        csgg csggVar2 = csgg.UNKNOWN;
        switch (csggVar) {
            case UNKNOWN:
                return 1;
            ...
            case EXCLUDED:
                return 22;
            default:
                throw new IllegalArgumentException("unknown enum value: ".concat(String.valueOf(String.valueOf(csggVar))));
        }
    }
