...
public final class btsz extends dtyq<btsn, btsz, btta, btrw, btsm> {
    public btsz(dtza dtzaVar) {
        super(dtzaVar);
    }
    ...
    public final /* synthetic */ dtsu a(dtve dtveVar, Cursor cursor, String[] strArr, dtzj[] dtzjVarArr, dtyo dtyoVar, dtvs dtvsVar) {
        return new btst(dtveVar, cursor, strArr, dtzjVarArr, dtyoVar, dtvsVar, this);
    }
