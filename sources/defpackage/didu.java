...
public final class didu implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < h) {
            ...
            if (d == 1) {
                ...
                arrayList = dfxj.z(parcel, readInt, FastPairAccountKeyParcelable.CREATOR);
            }
        }
        dfxj.B(parcel, h);
        return new GetFastpairAccountKeysResponse(i, arrayList);
    }
