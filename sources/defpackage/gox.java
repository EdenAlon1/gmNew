...
final class gox extends ffkk implements ffjm {
    ...
    public gox(hvi hviVar, idh idhVar, long j, float f, der derVar, dwn dwnVar, boolean z, ffix ffixVar, float f2, ffjm ffjmVar) {
        super(2);
        this.a = hviVar;
        this.b = idhVar;
        this.c = j;
    ...
    public final /* bridge */ /* synthetic */ Object a(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && hfdVar.I()) {
            ...
            a = dfb.c(gpa.a(a2, idhVar, c, this.e, ((jzn) hfdVar.e(jdr.e)).em(this.h)), this.j, gkw.a(false, 0.0f, 0L, 7), this.f, null, null, this.g, 24).a(new ChildSemanticsNodeElement(har.a));
