...
public final class erlu {
    private static final emvz a = new emvp('.');
    private static final emvz b = new emvp(':');

    static {
    }

    public static InetAddress a(String str) {
        erlt erltVar = new erlt();
        byte[] e = e(str, erltVar);
        if (e != null) {
            return d(e, erltVar.a);
        }
    ...
    private static InetAddress d(byte[] bArr, String str) {
        try {
            InetAddress byAddress = InetAddress.getByAddress(bArr);
            if (str == null) {
                return byAddress;
            }
            emxf.b(byAddress instanceof Inet6Address, "Unexpected state, scope should only appear for ipv6");
            ...
            try {
                ...
                throw new IllegalArgumentException(a.t(str, "No such interface: "), e);
            }
    ...
    */
    private static byte[] e(java.lang.String r13, defpackage.erlt r14) {
        /*
            Method dump skipped, instructions count: 353
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.erlu.e(java.lang.String, erlt):byte[]");
    }
