...
public final class sfe extends sex implements ekhu, fbas, ekhq, ekkk, elar {
    private sfk aj;
    private Context ak;
    ...
    @Override // defpackage.sex, defpackage.efad, defpackage.ea
    ...
    @Override // defpackage.sex, defpackage.ea
        ...
        try {
            ...
            if (this.aj == null) {
                try {
                    ...
                    if (!(eaVar instanceof sfe)) {
                        throw new IllegalStateException(a.J(eaVar, sfk.class));
                    }
                    akis akisVar = ((akgt) aX).a;
                    this.aj = new sfk((sfe) eaVar, akisVar.a.alj, akisVar.dk, (ejxn) ((akgt) aX).f.b(), (ffsk) ((akgt) aX).a.a.aq.b(), (ffsk) ((akgt) aX).g.b());
    ...
    public final void t(Bundle bundle) {
        sfk H = H();
        H.b.b.f("bugle");
        H.b.gi(R.xml.logging_consent_preference);
        sfe sfeVar = H.b;
        Preference a = sfeVar.a(sfeVar.Y(R.string.logging_consent_link_to_checkbox_pref_key));
        if (a != null) {
            a.N(false);
        ...
        sfe sfeVar2 = H.b;
        Preference a2 = sfeVar2.a(sfeVar2.Y(R.string.gaia_logging_consent_pref_key));
        if (a2 != null) {
            a2.N(false);
        ...
        sfe sfeVar3 = H.b;
        Preference a3 = sfeVar3.a(sfeVar3.Y(R.string.logging_consent_settings_learn_more_pref_key));
        sfe sfeVar4 = H.b;
        if (a3 != null) {
            a3.N(false);
            a3.M(ddyi.d(sfeVar4.G(), R.string.logging_consent_pref_inform));
        }
        H.e.g(R.id.logging_consent_subscription_mixin_id, new sfj(H, H.b.A()), new sfh(a, a2, a3, H, H.b));
    }
