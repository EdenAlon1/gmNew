...
public final class beix extends dtyq<beiw, beix, beiy, ConversationIdsQuery.BindData, beiv> {
    public beix(dtza dtzaVar) {
        super(dtzaVar);
    }
    ...
    public final /* synthetic */ dtsu a(dtve dtveVar, Cursor cursor, String[] strArr, dtzj[] dtzjVarArr, dtyo dtyoVar, dtvs dtvsVar) {
        return new beiw(dtveVar, cursor, strArr, dtzjVarArr, dtyoVar, dtvsVar, this);
    }
