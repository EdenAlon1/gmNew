...
public final class efav extends SSLSocketFactory {
    public static efas a = null;
    private static final String b = "efav";
    private final KeyManager[] c;
    private final TrustManager[] d;
    private final SecureRandom e;

    public efav(KeyManager[] keyManagerArr, TrustManager[] trustManagerArr, SecureRandom secureRandom) {
    ...
    private final SSLSocketFactory b() {
        try {
            ...
            if (trustManagerArr == null || trustManagerArr.length <= 0 || !(trustManagerArr[0] instanceof efaw)) {
