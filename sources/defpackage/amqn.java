...
public final class amqn implements amrh, amfx {
    public final amfx a;
    private final ffbz b = ffca.a(new ffix() { // from class: amqm
        @Override // defpackage.ffix
        public final Object invoke() {
            ConversationId c = amqn.this.a.c();
            c.getClass();
            return new EmergencyConversationId(((BugleConversationId) c).a);
        }
    });

    public amqn(amfx amfxVar) {
        this.a = amfxVar;
    }
