...
public final class dhly extends dfwc {
    public dhly(Context context, Looper looper, dfvs dfvsVar, dfrc dfrcVar, dfrd dfrdVar) {
        super(context, looper, 38, dfvsVar, dfrcVar, dfrdVar);
    }
