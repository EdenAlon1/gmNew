...
final class dtnc {
    ...
    public static Object a(Future future, long j, TimeUnit timeUnit) {
        if (!a || (future instanceof ernr) || (future instanceof dtnb) || TimeUnit.NANOSECONDS.convert(j, timeUnit) <= 2147483647999999999L || future.isDone()) {
    ...
    public static RunnableScheduledFuture b(RunnableScheduledFuture runnableScheduledFuture) {
        return a ? new dtnb(runnableScheduledFuture) : runnableScheduledFuture;
    }
}
