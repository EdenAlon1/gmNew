...
public final class bqzq extends dtyq<bqyp, bqzq, bqzs, bqwx, bqyo> {
    public bqzq(dtza dtzaVar) {
        super(dtzaVar);
    }
    ...
    public final /* synthetic */ dtsu a(dtve dtveVar, Cursor cursor, String[] strArr, dtzj[] dtzjVarArr, dtyo dtyoVar, dtvs dtvsVar) {
        return new bqzj(dtveVar, cursor, strArr, dtzjVarArr, dtyoVar, dtvsVar, this);
    }
