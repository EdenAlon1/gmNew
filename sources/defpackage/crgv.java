...
public final class crgv implements crgp {
    private final ffbr a;

    public crgv(ffbr ffbrVar) {
        ffbrVar.getClass();
        this.a = ffbrVar;
    }
    ...
    public final Object a(Set set, ffgu ffguVar) {
        ...
        ezkb ezkbVar = ezkb.RCS_TRANSPORT_TYPE_DUAL_REGISTRATION;
    ...
    public final Object b(crgw crgwVar, ffgu ffguVar) {
        Object c = fgfz.c(((ckly) this.a.b()).b(ezkb.RCS_TRANSPORT_TYPE_DUAL_REGISTRATION, crgwVar.b), ffguVar);
        return c == ffhh.a ? c : ffcu.a;
    }
