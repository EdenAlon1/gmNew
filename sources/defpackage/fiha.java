...
public final class fiha extends ExperimentalBidirectionalStream.Builder {
    private final fihm a;
    ...
    public fiha(String str, BidirectionalStream.Callback callback, Executor executor, fihm fihmVar) {
        str.getClass();
        this.b = str;
        callback.getClass();
        this.c = callback;
