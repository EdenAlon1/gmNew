...
public abstract class qlk implements Closeable {
    ...
    public abstract int c(qli qliVar);

    final qlh d(String str) {
        throw new qlh(str + " at path " + e());
    }
    ...
    final void l(int i) {
        ...
        if (i2 == length) {
            if (i2 == 256) {
                throw new qlg("Nesting too deep at ".concat(e()));
            }
