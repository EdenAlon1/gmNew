...
public final class brwo extends dtyq<brwa, brwo, brwp, brvg, brvz> {
    public brwo(dtza dtzaVar) {
        super(dtzaVar);
    }
    ...
    public final /* synthetic */ dtsu a(dtve dtveVar, Cursor cursor, String[] strArr, dtzj[] dtzjVarArr, dtyo dtyoVar, dtvs dtvsVar) {
        return new brwh(dtveVar, cursor, strArr, dtzjVarArr, dtyoVar, dtvsVar, this);
    }
