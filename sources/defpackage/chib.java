...
public final class chib implements chhw {
    private final chht a;

    public chib(chht chhtVar) {
        this.a = chhtVar;
    }

    private final fbot g() {
        return (fbot) chiu.c(fbov.a(this.a.a()), this.a.b(), false);
    }
    ...
    public final void f(fcat fcatVar, ffbc ffbcVar) {
        ...
        ((fbou) chiu.c(fbov.b(this.a.a()), this.a.b(), true)).b(fcatVar, ffbcVar);
    }
}
