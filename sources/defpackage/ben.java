...
public final class ben implements bhh, bet, blk {
    public static final bdn a = new bbf("camerax.core.imageAnalysis.backpressureStrategy", auk.class, null);
    public static final bdn b = new bbf("camerax.core.imageAnalysis.imageQueueDepth", Integer.TYPE, null);
    public static final bdn c = new bbf("camerax.core.imageAnalysis.imageReaderProxyProvider", avs.class, null);
    public static final bdn d = new bbf("camerax.core.imageAnalysis.outputImageFormat", aun.class, null);
    public static final bdn e = new bbf("camerax.core.imageAnalysis.onePixelShiftEnabled", Boolean.class, null);
    public static final bdn f = new bbf("camerax.core.imageAnalysis.outputImageRotationEnabled", Boolean.class, null);
    private final bfn h;

    public ben(bfn bfnVar) {
        this.h = bfnVar;
    }
    ...
    public final int G() {
        return ((Integer) bfy.c(this, a, 0)).intValue();
    }
