...
public final class ibn extends hvh implements itu {
    public ffji a;

    public ibn(ffji ffjiVar) {
        this.a = ffjiVar;
    }

    public final void a() {
        iwi iwiVar = isx.e(this, 2).u;
        if (iwiVar != null) {
            iwiVar.au(this.a, true);
        }
    }
    ...
    public final ipo b(ipq ipqVar, ipl iplVar, long j) {
        ipo ei;
        iqk e = iplVar.e(j);
        ei = ipqVar.ei(e.a, e.b, ffem.a, new ibm(e, this));
        return ei;
    }
