...
public final class akrb extends akqn implements ekhu, fbas, ekhq, ekkk, elar {
    private akrc ag;
    private Context ai;
    ...
    @Override // defpackage.akqn, defpackage.efae, defpackage.ea
    ...
    @Override // defpackage.akqn, defpackage.dn, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.ag == null) {
                try {
                    Object aX = aX();
                    this.ag = new akrc(((akgt) aX).as, ((akgt) aX).e(), ((akgt) aX).a.b.oJ);
    ...
    public final Dialog hf(Bundle bundle) {
        super.hf(bundle);
        akrc H = H();
        ehft ehftVar = new ehft(((akrb) H.a.b()).z());
        ehftVar.m(R.string.scheduled_message_overwrite_draft_message);
        ehftVar.t(R.string.scheduled_message_dialog_continue, new elll((ellq) H.c.b(), new akqi(H.b)));
        ehftVar.o(R.string.scheduled_message_dialog_back, new elll((ellq) H.c.b(), new akpr(H.b)));
    ...
    @Override // defpackage.akqn, defpackage.ea
