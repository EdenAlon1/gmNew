...
public final class famy implements evbl {
    public final engw f;
    public final enip g;
    private final enhk j;
    public static final ecda a = new ecda("mdi.aratea.ArateaService.");
    private static final ecda h = new ecda("mdi.aratea.ArateaService/");
    public static final evbk b = new famv();
    public static final evbk c = new famw();
    public static final evbk d = new famx();
    public static final famy e = new famy();
    ...
    private famy() {
        ...
        enhdVar.k("GenerateImageFromText", evbkVar);
        enhdVar.k("Generate", evbkVar2);
        enhdVar.k("EncryptedGenerate", evbkVar3);
        this.j = enhdVar.c();
        new enhd().c();
    }
