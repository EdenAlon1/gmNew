...
public abstract class fird {
    ...
    public abstract String k(int i, Locale locale);

    public abstract String l(long j, Locale locale);

    public abstract String m(int i, Locale locale);

    public abstract String n(long j, Locale locale);

    public abstract String o();

    public abstract firf p();

    public abstract firl q();

    public abstract firl r();

    public abstract firl s();
