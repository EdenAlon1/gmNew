...
public final class cpjn extends ceut {
    public static final entd a = entd.c("BugleTachygram");
    private final cpnb b;
    private final ffbr c;

    public cpjn(cpnb cpnbVar, ffbr ffbrVar) {
        this.b = cpnbVar;
        this.c = ffbrVar;
    }
    ...
    public final ekzz b() {
        return eleg.f("TachygramCreateGroupWorkHandler");
    }

    @Override // defpackage.ceve
    public final eyhz d() {
        return awuw.a.getParserForType();
    }
    ...
    protected final /* bridge */ /* synthetic */ elfl j(ceuw ceuwVar, eyhs eyhsVar) {
        return this.b.c(ceuwVar, (awuw) eyhsVar);
    }
}
