...
public final class dgai implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < h) {
            ...
            if (dfxj.d(readInt) != 1) {
                ...
                arrayList = dfxj.z(parcel, readInt, E2eeSelfKeyParcelable.CREATOR);
            }
        }
        dfxj.B(parcel, h);
        return new E2eeSelfKeyListParcelable(arrayList);
    }
