...
public enum enwp {
    ...
    static {
        ...
        for (enwp enwpVar : values()) {
            if (hashMap.put(Character.valueOf(enwpVar.G), enwpVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(String.valueOf(enwpVar))));
            }
        }
