...
class eglc extends ea implements fbat, fbam {
    ...
    protected final void b() {
        if (p(X()) && !this.e) {
            this.e = true;
            egla eglaVar = (egla) this;
            akgt akgtVar = (akgt) aX();
            eglaVar.a = akgtVar.b();
            eglaVar.b = (egrf) akgtVar.c.cW.b();
            eglaVar.c = (dvyc) akgtVar.a.b.jx.b();
            fbbf fbbfVar = akgtVar.ci;
            akgb akgbVar = akgtVar.c;
            eglaVar.d = new egbe(fbbfVar, akgbVar.cW, akgbVar.bF, akgbVar.cr, akgtVar.cg);
        }
    }
