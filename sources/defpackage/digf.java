...
public final class digf {
    ...
    private static digf c;
    private final Context d;

    public digf(Context context) {
        this.d = context.getApplicationContext();
    }

    public static digf a(Context context) {
        dfwv.n(context);
        synchronized (digf.class) {
            if (c == null) {
                c = new digf(context);
            }
        }
    ...
    public final boolean b() {
        ...
        boolean z;
        try {
            packageInfo = dfzj.b(this.d).b("com.google.android.wearable.app.cn", 64);
        } catch (PackageManager.NameNotFoundException unused) {
            packageInfo = null;
        }
        if (packageInfo != null) {
            if (dfqf.e(this.d)) {
                z = c(packageInfo, true);
            } else {
