...
public final class fiav implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient fhvm a;
    private transient ASN1Set b;

    public fiav(PrivateKeyInfo privateKeyInfo) {
        a(privateKeyInfo);
    }

    private final void a(PrivateKeyInfo privateKeyInfo) {
        this.b = privateKeyInfo.b;
        this.a = (fhvm) fhxy.a(privateKeyInfo);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof fiav) {
            return Arrays.equals(this.a.a(), ((fiav) obj).a.a());
        }
        return false;
    }
