...
public final class hne implements RandomAccess {
    public Object[] a;
    public int b = 0;
    private List c;

    public hne(Object[] objArr) {
        this.a = objArr;
    }
    ...
    public final boolean l(Object obj) {
        int i = this.b - 1;
        if (i >= 0) {
            for (int i2 = 0; !ffkj.e(this.a[i2], obj); i2++) {
                if (i2 != i) {
                }
            }
            return true;
    ...
    public final void o(int i, hne hneVar) {
        int i2 = hneVar.b;
        if (i2 == 0) {
            return;
        }
        ...
        System.arraycopy(hneVar.a, 0, objArr, i, i2);
        this.b += i2;
    }
