...
final class gud implements ipn {
    ...
    public final ipo e(ipq ipqVar, List list, long j) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (ffkj.e(ioe.b(iplVar), "Spacer")) {
                iqk e = iplVar.e(jzk.m(j, 0, 0, 0, ipqVar.eo(1.0f), 3));
                ...
                for (int i3 = 0; i3 < size3; i3++) {
                    arrayList2.add(((ipl) arrayList.get(i3)).e(jzk.m(j, 0, 0, 0, jzk.a(j) >> 1, 3)));
                }
                ei = ipqVar.ei(jzk.b(j), jzk.a(j), ffem.a, new guc(arrayList2, e));
                return ei;
            }
        }
