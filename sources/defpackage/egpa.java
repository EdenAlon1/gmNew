...
class egpa extends ehbo implements fbat, fbam {
    ...
    protected final void aU() {
        if (aY(X()) && !this.ag) {
            ...
            egpfVar.ai = akgtVar.b();
            egpfVar.aj = (lmw) akgtVar.c.cl.b();
            egpfVar.ak = akgtVar.a.b.cU();
            egpfVar.al = (dvyc) akgtVar.a.b.jx.b();
            egpfVar.am = (egaj) akgtVar.c.bU.b();
            egpfVar.an = (egdg) akgtVar.c.bF.b();
            egpfVar.ao = (emyg) akgtVar.a.b.oC.b();
            egpfVar.ap = (emyg) akgtVar.a.b.oC.b();
            egpfVar.aq = (dvxi) akgtVar.a.b.jA.b();
        }
    }
