...
final class eyic extends eydo implements RandomAccess {
    public static final Object[] a;
    public static final eyic b;
    private Object[] c;
    private int d;
    ...
    public final /* bridge */ /* synthetic */ eygr e(int i) {
        if (i >= this.d) {
            return new eyic(i == 0 ? a : Arrays.copyOf(this.c, i), this.d, true);
        }
    ...
    public eyic(Object[] objArr, int i, boolean z) {
        super(z);
        this.c = objArr;
        this.d = i;
    }
