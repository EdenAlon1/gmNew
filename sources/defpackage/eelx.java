...
public final class eelx extends eelv {
    public final eelk a;
    public int m;

    public eelx(int i, String str) {
        super(2);
        this.a = new eelk(i, str);
    }
    ...
    public final boolean A() {
        eekg eekgVar = this.g;
        if (eekgVar != null && "INVITE".equals(eekgVar.e())) {
            return z();
        }
        return false;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != null && (obj instanceof eelx) && this.a.equals(((eelx) obj).a)) {
