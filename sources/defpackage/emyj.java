...
public final class emyj {
    private static final emyi a;
    private static final emyi b;
    ...
    static {
        ...
        new emvx(new emvo('A', 'F'), new emvo('a', 'f'));
        ...
        emyh.a(173, hashSet2);
        emyh.b(1536, 1539, hashSet2);
        emyh.a(1757, hashSet2);
        emyh.a(1807, hashSet2);
        emyh.b(6068, 6069, hashSet2);
        emyh.b(8203, 8207, hashSet2);
        emyh.b(8234, 8238, hashSet2);
        emyh.b(8288, 8292, hashSet2);
        emyh.b(8298, 8303, hashSet2);
        emyh.a(65279, hashSet2);
        emyh.b(65529, 65531, hashSet2);
        emyh.b(119155, 119162, hashSet2);
        emyh.a(917505, hashSet2);
        emyh.b(917536, 917631, hashSet2);
        emyh.a(0, hashSet2);
        emyh.a(10, hashSet2);
        emyh.a(13, hashSet2);
        emyh.b(8232, 8233, hashSet2);
        emyh.a(133, hashSet2);
        emyh.a(Character.codePointAt("'", 0), hashSet2);
        emyh.a(Character.codePointAt("\"", 0), hashSet2);
        emyh.a(Character.codePointAt("&", 0), hashSet2);
        emyh.a(Character.codePointAt("<", 0), hashSet2);
        emyh.a(Character.codePointAt(">", 0), hashSet2);
        emyh.a(Character.codePointAt("=", 0), hashSet2);
        emyh.a(Character.codePointAt("\\", 0), hashSet2);
        emyi emyiVar = new emyi(hashSet2);
        a = emyiVar;
        HashSet hashSet3 = new HashSet();
        emyh.a(Character.codePointAt("\"", 0), hashSet3);
        emyh.a(Character.codePointAt("\\", 0), hashSet3);
        emyh.b(0, 31, hashSet3);
        emyi emyiVar2 = new emyi(hashSet3);
        b = emyiVar2;
        HashSet hashSet4 = new HashSet();
        emyh.c(emyiVar2, hashSet4);
        emyh.c(emyiVar, hashSet4);
        new emyi(hashSet4);
    }

    public static boolean a(String str) {
        return str == null || emvy.b.h(str);
    }
}
