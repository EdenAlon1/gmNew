...
public final class etrc {
    ...
    static etrb a(etrb etrbVar, etrb etrbVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (etrbVar.a()) {
            return etrbVar2;
        }
        if (etrbVar2.a()) {
        ...
        BigInteger bigInteger3 = etrbVar.d;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = etrbVar2.d;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = etrbVar.b.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = etrbVar2.b.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = etrbVar.c.multiply(etrbVar2.d).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = etrbVar2.c.multiply(etrbVar.d).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (mod3.equals(mod4)) {
            return !mod5.equals(mod6) ? etrb.a : b(etrbVar, bigInteger, bigInteger2);
        }
        ...
        BigInteger add = etrbVar.d.add(etrbVar2.d);
        return new etrb(mod12, mod13, add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod2).multiply(mod7).mod(bigInteger2));
    }

    static etrb b(etrb etrbVar, BigInteger bigInteger, BigInteger bigInteger2) {
        if (etrbVar.c.equals(BigInteger.ZERO)) {
            return etrb.a;
        }
        BigInteger bigInteger3 = etrbVar.b;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = etrbVar.c;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger bigInteger5 = etrbVar.d;
        BigInteger mod4 = bigInteger5.multiply(bigInteger5).mod(bigInteger2);
        BigInteger add = etrbVar.b.add(mod2);
        ...
        BigInteger add3 = etrbVar.c.add(etrbVar.d);
        return new etrb(mod5, mod6, add3.multiply(add3).mod(bigInteger2).subtract(mod2).subtract(mod4).mod(bigInteger2));
    }

    static etrb c(ECPoint eCPoint, BigInteger bigInteger) {
        if (eCPoint.equals(ECPoint.POINT_INFINITY)) {
            return etrb.a;
        }
        BigInteger mod = new BigInteger(1, ettg.b((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger mod2 = mod.multiply(mod).mod(bigInteger);
        return new etrb(eCPoint.getAffineX().multiply(mod2).mod(bigInteger), eCPoint.getAffineY().multiply(mod2.multiply(mod).mod(bigInteger)).mod(bigInteger), mod);
    }
    ...
    public static ECPoint e(BigInteger bigInteger, ECParameterSpec eCParameterSpec) {
        ...
        etrb c2 = c(ECPoint.POINT_INFINITY, d2);
        etrb c3 = c(generator, d2);
