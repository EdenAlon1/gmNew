...
public final class rb extends MultiAutoCompleteTextView {
    ...
    public rb(Context context, AttributeSet attributeSet) {
        ...
        yt l = yt.l(getContext(), attributeSet, a, com.google.android.apps.messaging.R.attr.autoCompleteTextViewStyle, 0);
        if (l.q(0)) {
        ...
        this.b = qoVar;
        qoVar.b(attributeSet, com.google.android.apps.messaging.R.attr.autoCompleteTextViewStyle);
        ry ryVar = new ry(this);
        this.c = ryVar;
        ryVar.h(attributeSet, com.google.android.apps.messaging.R.attr.autoCompleteTextViewStyle);
        ryVar.e();
        qx qxVar = new qx(this);
        this.d = qxVar;
        qxVar.b(attributeSet, com.google.android.apps.messaging.R.attr.autoCompleteTextViewStyle);
