...
public abstract class gp {
        ...
        for (int i = size; i < list.size(); i++) {
            ...
            if (view2 instanceof ViewGroup) {
                ...
                for (int i2 = 0; i2 < childCount; i2++) {
                    ...
                    if (!f(list, childAt, size) && kvd.f(childAt) != null) {
                        list.add(childAt);
                    }
                }
            }
    ...
    public void q(Object obj, kqs kqsVar, Runnable runnable) {
        throw null;
    }
    ...
    public void z(Object obj, kqs kqsVar, Runnable runnable, Runnable runnable2) {
        runnable2.run();
    }
