...
public final class dhyb implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < h) {
            ...
            if (d == 1) {
                ...
                setupWizardInstrumentManagerParams = (SetupWizardInstrumentManagerParams) dfxj.n(parcel, readInt, SetupWizardInstrumentManagerParams.CREATOR);
            }
        }
        dfxj.B(parcel, h);
