...
public final class fijg extends fihm {
    private static final String e = "fijg";
    public final int a;
    public final fiic b;
    ...
    public fijg(fihq fihqVar) {
        new fiev("JavaCronetEngine#JavaCronetEngine");
        try {
            Context context = fihqVar.c;
            this.d = context;
            int hashCode = hashCode();
            this.a = hashCode;
            int b = fihqVar.b(9);
            this.f = fihqVar.h;
            this.g = new ThreadPoolExecutor(10, 10, 50L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new fije(b));
            fiic a = fiid.a(context, fihz.CRONET_SOURCE_FALLBACK);
            this.b = a;
            try {
                a.c(hashCode, fihqVar.d(), new fiib("CronetHttpURLConnection/".concat(ImplVersion.getCronetVersionWithLastChange()).split("/")[1].split("@")[0]), fihz.CRONET_SOURCE_FALLBACK);
    ...
    public final ExperimentalUrlRequest b(String str, UrlRequest.Callback callback, Executor executor, int i, Collection collection, boolean z, boolean z2, boolean z3, boolean z4, int i2, boolean z5, int i3, RequestFinishedInfo.Listener listener, int i4, long j, String str2, ArrayList arrayList, UploadDataProvider uploadDataProvider, Executor executor2, byte[] bArr, ByteBuffer byteBuffer, String str3) {
        ...
        return new fikx(this, callback, this.g, executor, str, this.f, z3, z4, i2, z5, i3, this.h, str2, arrayList, uploadDataProvider, executor2);
    }
