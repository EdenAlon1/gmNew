...
public final class duud extends wr {
    public final CustomImageView s;
    public final duub t;

    public duud(ViewGroup viewGroup, int i, int i2, View.OnClickListener onClickListener, View.OnLongClickListener onLongClickListener) {
