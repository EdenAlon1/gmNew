...
public final class dtjy implements ipn {
    final /* synthetic */ hho a;
    final /* synthetic */ kgq b;
    final /* synthetic */ kgj c;
    final /* synthetic */ hho d;

    public dtjy(hho hhoVar, kgq kgqVar, kgj kgjVar, hho hhoVar2) {
        this.a = hhoVar;
        this.b = kgqVar;
        this.c = kgjVar;
        this.d = hhoVar2;
    ...
    public final ipo e(ipq ipqVar, List list, long j) {
        ...
        this.d.a();
        ei = ipqVar.ei(kaf.b(d), kaf.a(d), ffem.a, new dtjx(this.b, list, linkedHashMap));
        return ei;
    }
}
