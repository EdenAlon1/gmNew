...
public final class cye {
    ...
    public cye(int i, float f, float f2, float f3, float f4, float f5, float f6) {
        float[] fArr;
        this.a = f;
        this.b = f2;
        this.j = f3;
        ...
        if (i == 3 || Math.abs(f8) < 0.001f || Math.abs(f7) < 0.001f) {
            ...
            while (true) {
                ...
                double d = sin - f15;
                fArr = fArr2;
                f14 += (float) Math.hypot(d, cos - f13);
                fArr3[i2] = f14;
                if (i2 == 90) {
                    break;
                }
            ...
            for (int i4 = 0; i4 < 101; i4++) {
                float f16 = i4 / 100.0f;
                int binarySearch = Arrays.binarySearch(fArr3, 0, 91, f16);
                if (binarySearch >= 0) {
                    ...
                    int i7 = i5 - 2;
                    float f17 = fArr3[i7];
                    fArr[i4] = (i7 + ((f16 - f17) / (fArr3[i6] - f17))) / 90.0f;
                }
            }
