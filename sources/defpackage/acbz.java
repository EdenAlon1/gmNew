...
public final class acbz extends accj implements ekhu, fbas, ekhq, ekkk, elar {
    private accd ag;
    private Context ai;
    ...
    @Override // defpackage.accj, defpackage.efae, defpackage.ea
    ...
    @Override // defpackage.accj, defpackage.dn, defpackage.ea
        ...
        try {
            ...
            if (this.ag == null) {
                try {
                    ...
                    accf accfVar = (accf) ProtoParsers.f(a, "TIKTOK_FRAGMENT_ARGUMENT", accf.a, eyfcVar);
                    accfVar.getClass();
                    ea eaVar = (ea) ((fbbb) ((akgt) aX).d).a;
                    if (!(eaVar instanceof acbz)) {
                        throw new IllegalStateException(a.J(eaVar, accd.class));
                    }
                    this.ag = new accd(accfVar, (acbz) eaVar, ((akgt) aX).a.cz);
    ...
    public final Dialog hf(Bundle bundle) {
        super.hf(bundle);
        final accd H = H();
        ZonedDateTime atZone = ((cqoh) H.e.b()).f().atZone(ZoneId.systemDefault());
        ZonedDateTime atZone2 = Instant.ofEpochMilli(H.a.b).atZone(ZoneId.systemDefault());
        eg G = H.c.G();
        G.getClass();
        accc acccVar = new accc(G, new TimePickerDialog.OnTimeSetListener() { // from class: acca
            @Override // android.app.TimePickerDialog.OnTimeSetListener
            public final void onTimeSet(TimePicker timePicker, int i, int i2) {
                accd.this.onTimeSet(timePicker, i, i2);
            }
        }, atZone.getHour(), atZone.getMinute(), DateFormat.is24HourFormat(H.b), atZone, atZone2);
        acccVar.setButton(-1, H.b.getString(R.string.datetime_picker_next_button), acccVar);
        acccVar.setButton(-2, H.b.getString(R.string.datetime_picker_back_button), new DialogInterface.OnClickListener() { // from class: accb
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                ellj.f(new accm(), accd.this.d);
            }
        });
        return acccVar;
    }
    ...
    @Override // defpackage.accj, defpackage.ea
