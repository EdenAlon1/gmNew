...
public final class cwxu extends cxis implements ekhu, fbas, ekhq, ekkk, elar {
    private cwxy a;
    private boolean ag;
    private Context d;
    ...
    public final View M(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            viewGroup.getClass();
            View inflate = layoutInflater.inflate(R.layout.hqms_settings_gaia_logged_in_card, viewGroup, false);
            inflate.getClass();
            ekyf.q();
            return inflate;
        } catch (Throwable th) {
    ...
    @Override // defpackage.cxis, defpackage.efaf, defpackage.ea
    ...
    public final void ap(View view, Bundle bundle) {
        ...
        try {
            ...
            cwxy H = H();
            view.getClass();
            axol.k(lks.a(H.a), null, new cwxx(H, view, null), 3);
            ekyf.q();
        } catch (Throwable th) {
            try {
                ekyf.q();
    ...
    @Override // defpackage.cxis, defpackage.ekkd, defpackage.ea
        ...
        try {
            ...
            if (this.a == null) {
                try {
                    ...
                    if (!(eaVar instanceof cwxu)) {
                        throw new IllegalStateException(a.J(eaVar, cwxy.class));
                    }
                    this.a = new cwxy((cwxu) eaVar, ((akgo) aX).b.b, ((akgo) aX).a.a.as, (ekmz) ((akgo) aX).eI.b());
    ...
    @Override // defpackage.cxis, defpackage.ea
