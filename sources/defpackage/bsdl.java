...
public final class bsdl extends dtyq<bsdb, bsdl, bsdm, bscj, bsda> {
    public bsdl(dtza dtzaVar) {
        super(dtzaVar);
    }
    ...
    public final /* synthetic */ dtsu a(dtve dtveVar, Cursor cursor, String[] strArr, dtzj[] dtzjVarArr, dtyo dtyoVar, dtvs dtvsVar) {
        return new bsdg(dtveVar, cursor, strArr, dtzjVarArr, dtyoVar, dtvsVar, this);
    }
