...
public final class eudr {
    ...
    public final euds a() {
        ...
        BigInteger bigInteger = euduVar.b;
        ...
        BigInteger bigInteger5 = eudqVar.c;
        ...
        if (bigInteger4.multiply(eujuVar6.a).mod(bigInteger3).equals(BigInteger.ONE)) {
            return new euds(this.a, this.d, this.e, this.b, this.f, this.g, this.c);
        }
