...
public final class fhtv extends ASN1Object {
    public final int a;
    public final int b;
    public final AlgorithmIdentifier c;
    private final ASN1Integer d;

    public fhtv(int i, int i2, AlgorithmIdentifier algorithmIdentifier) {
    ...
    public static fhtv a(Object obj) {
        if (obj instanceof fhtv) {
            return (fhtv) obj;
        }
        if (obj != null) {
            return new fhtv(ASN1Sequence.j(obj));
        }
        return null;
    }
    ...
    private fhtv(ASN1Sequence aSN1Sequence) {
