...
public abstract class edzw extends SSLSocket {
    public final SSLSocket a;
    private final Map d = new HashMap();
    public final Map b = new HashMap();
    public final Map c = new HashMap();

    public edzw(SSLSocket sSLSocket) {
        this.a = sSLSocket;
    }
    ...
    public final void addHandshakeCompletedListener(final HandshakeCompletedListener handshakeCompletedListener) {
        emxf.b(handshakeCompletedListener != null, "expected listener to be non-null");
        removeHandshakeCompletedListener(handshakeCompletedListener);
        this.d.put(handshakeCompletedListener, new HandshakeCompletedListener() { // from class: edzv
            @Override // javax.net.ssl.HandshakeCompletedListener
            public final void handshakeCompleted(HandshakeCompletedEvent handshakeCompletedEvent) {
                handshakeCompletedListener.handshakeCompleted(new HandshakeCompletedEvent(edzw.this, handshakeCompletedEvent.getSession()));
            }
        });
        this.a.addHandshakeCompletedListener((HandshakeCompletedListener) this.d.get(handshakeCompletedListener));
    }
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof edzw) {
            return this == obj || this.a.equals(((edzw) obj).a);
        }
        return false;
    }
    ...
    public final SSLSession getHandshakeSession() {
        ...
        handshakeSession = this.a.getHandshakeSession();
    ...
    public InputStream getInputStream() {
        return (InputStream) Map.EL.computeIfAbsent(this.b, this.a.getInputStream(), new edzt(this));
    }
    ...
    public OutputStream getOutputStream() {
        return (OutputStream) Map.EL.computeIfAbsent(this.c, this.a.getOutputStream(), new edzu(this));
    }
    ...
    public final int hashCode() {
        return Objects.hash(edzw.class, this.a);
    }
