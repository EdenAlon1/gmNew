...
class efwz extends dn implements fbat, fbam {
    ...
    protected final void aU() {
        if (aY(X()) && !this.al) {
            ...
            entd entdVar = dwbz.a;
            efwrVar.ag = new dwcq(emxc.j(new dwbx()));
            efwrVar.ah = (egjw) akgtVar.c.bV.b();
            efwrVar.ai = (dvxi) akgtVar.a.b.jA.b();
            efwrVar.aj = (dvxy) akgtVar.a.b.jy.b();
            efwrVar.ak = (dvyc) akgtVar.a.b.jx.b();
        }
    }
