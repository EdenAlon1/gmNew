...
public final class egkn implements erqj {
    final /* synthetic */ egko a;

    public egkn(egko egkoVar) {
        this.a = egkoVar;
    }
    ...
    public final /* synthetic */ void b(Object obj) {
        ...
        egkjVar.c((Uri) obj);
        egkjVar.a = 4;
        exfv exfvVar = (exfv) egko.b.toBuilder();
        ...
        this.a.h.j(egkjVar.a());
        this.a.i.set(false);
    }

    @Override // defpackage.erqj
    public final void hx(Throwable th) {
        ((enrr) ((enrr) ((enrr) egko.a.e()).g(th)).h("com/google/android/libraries/user/profile/photopicker/edit/viewmodel/EditViewModel$1", "onFailure", 'd', "EditViewModel.java")).q("Something went wrong with saving the bitmap");
        egkj egkjVar = new egkj();
        egkjVar.a = 5;
        exfv exfvVar = (exfv) egko.b.toBuilder();
