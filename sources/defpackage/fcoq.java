...
public final class fcoq implements evbl {
    public final engw l;
    public final enip m;
    private final enhk p;
    public static final ecda a = new ecda("google.internal.communications.instantmessaging.v1.LighterCloudMessageService.");
    private static final ecda n = new ecda("google.internal.communications.instantmessaging.v1.LighterCloudMessageService/");
    public static final evbk b = new fcoh();
    public static final evbk c = new fcoi();
    public static final evbk d = new fcoj();
    public static final evbk e = new fcok();
    public static final evbk f = new fcol();
    public static final evbk g = new fcom();
    public static final evbk h = new fcon();
    public static final evbk i = new fcoo();
    public static final evbk j = new fcop();
    public static final fcoq k = new fcoq();
    private static final ecda o = new ecda("instantmessaging-pa.googleapis.com");
    ...
    private fcoq() {
        ...
        evbk evbkVar8 = i;
        evbk evbkVar9 = j;
        enip.v(evbkVar, evbkVar2, evbkVar3, evbkVar4, evbkVar5, evbkVar6, evbkVar7, evbkVar8, evbkVar9);
        enhd enhdVar = new enhd();
        enhdVar.k("ListConversations", evbkVar);
        enhdVar.k("ListMessages", evbkVar2);
        enhdVar.k("AddAnnotationToMessages", evbkVar3);
        enhdVar.k("RemoveAnnotationFromMessages", evbkVar4);
        enhdVar.k("AddAnnotationToConversations", evbkVar5);
        enhdVar.k("RemoveAnnotationFromConversations", evbkVar6);
        enhdVar.k("DeleteConversations", evbkVar7);
        enhdVar.k("DeleteMessages", evbkVar8);
        enhdVar.k("CheckBootstrapRequired", evbkVar9);
        this.p = enhdVar.c();
        new enhd().c();
    }
    ...
    public final evbk b(String str) {
        ...
        if (this.p.containsKey(substring)) {
            return (evbk) this.p.get(substring);
        }
        return null;
    }
}
