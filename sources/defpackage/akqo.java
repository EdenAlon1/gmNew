...
public final class akqo extends akql implements ekhu, fbas, ekhq, ekkk, elar {
    private akqp ag;
    private Context ai;
    ...
    @Override // defpackage.akql, defpackage.efae, defpackage.ea
    ...
    @Override // defpackage.akql, defpackage.dn, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.ag == null) {
                try {
                    Object aX = aX();
                    this.ag = new akqp(((akgt) aX).aq, ((akgt) aX).e(), ((akgt) aX).a.b.oJ);
    ...
    public final Dialog hf(Bundle bundle) {
        super.hf(bundle);
        akqp H = H();
        ehft ehftVar = new ehft(((akqo) H.a.b()).z());
        ehftVar.m(R.string.scheduled_message_delete_confirmation);
        ehftVar.t(R.string.scheduled_message_dialog_continue, new elll((ellq) H.c.b(), new akqg(H.b.b)));
    ...
    @Override // defpackage.akql, defpackage.ea
