...
public final class dekk implements deki {
    public final ffbr a;
    public final ffbr b;
    public final ffbr c;
    public final fgcm d;
    ...
    public dekk(ffbr ffbrVar, ffbr ffbrVar2, ffsk ffskVar, ffbr ffbrVar3) {
        ffbrVar2.getClass();
        ffskVar.getClass();
        ffbrVar3.getClass();
        this.a = ffbrVar;
    ...
    public final void b(eixn eixnVar) {
        if (eixnVar == null || (((avdj) this.c.b()).a() && !ffkj.e(eixnVar.b().k, "google"))) {
            ...
            axol.k(this.e, null, new dekj(this, eixnVar, null), 3);
        }
    }
}
