...
final class fhwx {
    ...
    static {
        ...
        for (int i3 = 0; i3 < 256; i3 += 8) {
            long e = e(j);
            long e2 = e(e);
            long d = d(d(e2, e), e(e2));
            ficw.h(d(e, e(d(e(e(e(d))), d))), b, i3);
            j += 578721382704613384L;
        }
    }
    ...
    private static long c(long j, long j2) {
        long g = g(j, j2);
        long j3 = 3689348814741910323L & g;
        return (g(((j ^ (j << 2)) & (-3689348814741910324L)) ^ ((g & (-3689348814741910324L)) >>> 2), ((j2 ^ (j2 << 2)) & (-3689348814741910324L)) ^ 2459565876494606882L) ^ (j3 << 2)) ^ j3;
    }

    private static long d(long j, long j2) {
        long c = c(j, j2);
        long j3 = 1085102592571150095L & c;
        return (c(((j ^ (j << 4)) & (-1085102592571150096L)) ^ ((c & (-1085102592571150096L)) >>> 4), ((j2 ^ (j2 << 4)) & (-1085102592571150096L)) ^ 578721382704613384L) ^ (j3 << 4)) ^ j3;
    }

    private static long e(long j) {
        long j2 = j ^ (((-6148914691236517206L) & j) >>> 1);
        long f = j2 ^ (f((-3689348814741910324L) & j2) >>> 2);
        long j3 = (-4557430888798830400L) & f;
        long j4 = j3 >>> 2;
        return f ^ ((f((((3472328296227680304L & f) << 2) ^ j3) ^ j4) ^ j4) >>> 4);
    }
