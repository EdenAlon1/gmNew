...
public final class fiam implements PrivateKey, Key {
    private static final long serialVersionUID = 1;
    private transient fhui a;
    private transient ASN1Set b;

    public fiam(PrivateKeyInfo privateKeyInfo) {
        a(privateKeyInfo);
    }

    private final void a(PrivateKeyInfo privateKeyInfo) {
        this.b = privateKeyInfo.b;
        this.a = (fhui) fhxy.a(privateKeyInfo);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof fiam) {
            return Arrays.equals(this.a.a(), ((fiam) obj).a.a());
        }
        return false;
    }
