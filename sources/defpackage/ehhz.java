...
public class ehhz extends ua {
    ...
    public ehhz(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public ehhz(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = true;
        this.b = false;
        TypedArray a = ehiz.a(context, attributeSet, ehil.b, i, 0, new int[0]);
