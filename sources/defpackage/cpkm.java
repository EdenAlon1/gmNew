...
public final class cpkm extends ceut {
    public static final entd a = entd.c("BugleTachygram");
    private final cpnb b;
    private final ffbr c;

    public cpkm(cpnb cpnbVar, ffbr ffbrVar) {
        this.b = cpnbVar;
        this.c = ffbrVar;
    }
    ...
    public final ekzz b() {
        return eleg.f("TachygramGetGroupInfoWorkHandler");
    }

    @Override // defpackage.ceve
    public final eyhz d() {
        return axaj.a.getParserForType();
    }
    ...
    protected final /* bridge */ /* synthetic */ elfl j(ceuw ceuwVar, eyhs eyhsVar) {
        return this.b.c(ceuwVar, (axaj) eyhsVar);
    }
}
