...
public final class dkqp {
    public static final diyy a = dizd.a(185217001);
    private static volatile dkqp b;
    private final ConcurrentHashMap c;

    private dkqp(Context context) {
    ...
    public static synchronized dkqp a(Context context) {
        synchronized (dkqp.class) {
            dkqp dkqpVar = b;
            if (dkqpVar != null) {
                return dkqpVar;
            }
            dkqp dkqpVar2 = new dkqp(context);
            b = dkqpVar2;
            return dkqpVar2;
        }
    }
    ...
    public final Optional b(String str) {
        return Optional.ofNullable((dkqo) this.c.get(str));
    }
