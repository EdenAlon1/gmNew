...
public final class bfkk extends dtyx<bfkf, bfki, bfkk, bejf, bfke> {
    public bfkk(String[] strArr) {
    ...
    public final bfki b() {
        l();
        return new bfki(this.a.a());
    }

    public final void c(bfkh... bfkhVarArr) {
        C((String) DesugarArrays.stream(bfkhVarArr).map(new Function() { // from class: bfkj
    ...
    public final void d(bfkp bfkpVar) {
        k(new bfkl(bfkpVar));
    }
