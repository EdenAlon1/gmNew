...
final class fiso {
    ...
    private fiso(Locale locale) {
        DateFormatSymbols b = firh.b(locale);
        this.a = b.getEras();
    ...
    static fiso a(Locale locale) {
        if (locale == null) {
            locale = Locale.getDefault();
        }
        ConcurrentMap concurrentMap = n;
        fiso fisoVar = (fiso) concurrentMap.get(locale);
        if (fisoVar != null) {
            return fisoVar;
        }
        fiso fisoVar2 = new fiso(locale);
        fiso fisoVar3 = (fiso) concurrentMap.putIfAbsent(locale, fisoVar2);
        return fisoVar3 == null ? fisoVar2 : fisoVar3;
    }
