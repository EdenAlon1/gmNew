...
public final class bojc extends dtyq<boja, bojc, boje, ParticipantIdsQuery.BindData, boiz> {
    public bojc(dtza dtzaVar) {
        super(dtzaVar);
    }
    ...
    public final /* synthetic */ dtsu a(dtve dtveVar, Cursor cursor, String[] strArr, dtzj[] dtzjVarArr, dtyo dtyoVar, dtvs dtvsVar) {
        return new boja(dtveVar, cursor, strArr, dtzjVarArr, dtyoVar, dtvsVar, this);
    }
