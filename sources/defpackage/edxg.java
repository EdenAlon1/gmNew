...
public final class edxg implements edvo {
    private static final enru a = enru.c("com/google/android/libraries/privatetelemetry/mobalt/observations/AtLeastOnceObservationGenerator");
    ...
    public edxg(edxz edxzVar, edxx edxxVar, edxm edxmVar, SecureRandom secureRandom, int i, int i2, emsj emsjVar, emtc emtcVar) {
        this.b = edxzVar;
        this.c = edxxVar;
        this.d = edxmVar;
        this.e = secureRandom;
    ...
    */
    public final /* synthetic */ java.util.List a(int r21, java.util.List r22) {
        /*
            Method dump skipped, instructions count: 644
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.edxg.a(int, java.util.List):java.util.List");
    }
}
