...
public final class bdts implements aoar {
    private final String a;
    private final appw c;
    private final aoav b = aoav.a;
    private final eooi d = eooi.PHONE_SMART_REPLY;

    public bdts(final SmartSuggestionItemSuggestionData smartSuggestionItemSuggestionData) {
        this.a = smartSuggestionItemSuggestionData.a;
        this.c = new appw() { // from class: bdtr
