...
public final class hnf {
    ...
    private static final void c(int i, int i2) {
        throw new IndexOutOfBoundsException(a.x(i2, i, "Index ", " is out of bounds. The list has ", " elements."));
    }
    ...
    private static final void f(int i, int i2) {
        throw new IllegalArgumentException(a.x(i2, i, "Indices are out of order. fromIndex (", ") is greater than toIndex (", ")."));
    }
}
