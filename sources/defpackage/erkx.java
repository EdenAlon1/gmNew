    ...
    */
    public static int a(double r5, java.math.RoundingMode r7) {
        /*
            ...
            r2 = 1
            if (r0 <= 0) goto L10
            boolean r0 = defpackage.erky.c(r5)
            if (r0 == 0) goto L10
            r0 = r2
            goto L11
        L10:
        ...
        L71:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.erkx.a(double, java.math.RoundingMode):int");
    }
    ...
    public static boolean c(double d) {
        if (erky.c(d)) {
            return d == eobe.a || 52 - Long.numberOfTrailingZeros(erky.b(d)) <= Math.getExponent(d);
        }
        return false;
    }

    public static boolean d(double d) {
        if (d > eobe.a && erky.c(d)) {
            long b = erky.b(d);
            if ((b & ((-1) + b)) == 0) {
                return true;
            }
