...
public final class dhnr implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < h) {
            ...
            if (d == 1) {
                ...
                getGlobalSearchSourcesCall$GlobalSearchSourceArr = (GetGlobalSearchSourcesCall$GlobalSearchSource[]) dfxj.J(parcel, readInt, GetGlobalSearchSourcesCall$GlobalSearchSource.CREATOR);
            }
        }
        dfxj.B(parcel, h);
