...
public final class vxk extends vxy implements ekhu, fbas, ekhq, ekkk, elar {
    private vxn a;
    private boolean ag;
    private Context d;
    ...
    public final View M(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            H();
            View inflate = layoutInflater.inflate(R.layout.conversation_root_fragment, viewGroup, false);
            ekyf.q();
            return inflate;
        } catch (Throwable th) {
            try {
    ...
    @Override // defpackage.vxy, defpackage.efaf, defpackage.ea
    ...
    @Override // defpackage.vxy, defpackage.ekkd, defpackage.ea
        ...
        try {
            ...
            if (this.a == null) {
                try {
                    ...
                    if (!(eaVar instanceof vxk)) {
                        throw new IllegalStateException(a.J(eaVar, vxn.class));
                    }
                    this.a = new vxn(eisxVar, (vxk) eaVar, fbaz.a(((akgo) aX).d.C), ((akgo) aX).a.b.jc);
    ...
    @Override // defpackage.vxy, defpackage.ea
