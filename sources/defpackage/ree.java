...
public final class ree extends FilterInputStream implements InputStreamRetargetInterface {
    ...
    public ree(InputStream inputStream, qxd qxdVar) {
        super(inputStream);
        this.d = -1;
        this.f = qxdVar;
        this.a = (byte[]) qxdVar.a(65536, byte[].class);
    }
    ...
    */
    private final int c(java.io.InputStream r6, byte[] r7) {
        ...
        L61:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ree.c(java.io.InputStream, byte[]):int");
    }
    ...
    public final synchronized void reset() {
        ...
        int i = this.d;
        if (i == -1) {
            throw new red("Mark has been invalidated, pos: " + this.e + " markLimit: " + this.c);
        }
        this.e = i;
    }
    ...
    */
    public final synchronized int read(byte[] r6, int r7, int r8) {
        ...
        L84:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ree.read(byte[], int, int):int");
    }
}
