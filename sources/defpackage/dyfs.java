...
final class dyfs extends BroadcastReceiver {
    final /* synthetic */ emyl a;
    final /* synthetic */ Account b;

    public dyfs(emyl emylVar, Account account) {
        this.a = emylVar;
        this.b = account;
    }

    /* JADX WARN: Type inference failed for: r0v1, types: [dyfl, java.lang.Object] */
