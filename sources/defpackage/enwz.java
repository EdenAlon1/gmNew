...
public class enwz extends enwx {
    ...
    static {
        ...
        Le:
            java.lang.String r0 = "\n"
        L10:
            defpackage.enwz.a = r0
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.enwz.<clinit>():void");
    }
    ...
    public static int b(String str, int i) {
        while (i < str.length()) {
            ...
            if (str.charAt(i) != '%') {
                ...
                if (i2 >= str.length()) {
                    throw enwy.c("trailing unquoted '%' character", str, i);
                }
