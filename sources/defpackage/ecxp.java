...
public final class ecxp implements Comparable {
    final long a;
    final String b;
    public final int c;
    public final long d;
    ...
    public ecxp(long j, String str, int i, long j2, Object obj) {
        emxf.a(((j > 0L ? 1 : (j == 0L ? 0 : -1)) == 0) == (str != null));
        this.a = j;
        this.b = str;
        this.c = i;
        this.d = j2;
        ...
        } else if ((obj instanceof byte[]) || (obj instanceof eyee)) {
            this.f = null;
        } else {
    ...
    public final Object b() {
        ...
        obj2.getClass();
        try {
            return obj2 instanceof byte[] ? (byte[]) obj2 : ((eyee) obj2).I();
        } catch (Throwable th) {
    ...
    public final /* bridge */ /* synthetic */ int compareTo(Object obj) {
        ecxp ecxpVar = (ecxp) obj;
        int compare = Long.compare(this.a, ecxpVar.a);
        if (compare != 0) {
            return compare;
        }
        if (this.a != 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof ecxp)) {
            return false;
        }
        ecxp ecxpVar = (ecxp) obj;
        return this.a == ecxpVar.a && Objects.equals(this.b, ecxpVar.b);
    }
