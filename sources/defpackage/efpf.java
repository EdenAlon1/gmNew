...
public final class efpf extends LinearLayout {
    public final Button a;
    public final Button b;

    public efpf(Context context) {
        super(context);
        setOrientation(1);
    ...
    private final void a(Button button) {
        efoi.e(findViewById(R.id.survey_prompt_buttons), button, 0, R.dimen.survey_button_accessibility_padding);
    }
}
