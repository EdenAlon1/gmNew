...
final class euui {
    ...
    private euui(FileChannel fileChannel, FileLock fileLock) {
        this.a = fileChannel;
        this.b = fileLock;
    }
    ...
    */
    static defpackage.euui b(android.content.Context r5) {
        /*
            ...
            euui r2 = new euui     // Catch: java.nio.channels.OverlappingFileLockException -> L25 java.lang.Error -> L27 java.io.IOException -> L29
        ...
        L4c:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.euui.b(android.content.Context):euui");
    }
