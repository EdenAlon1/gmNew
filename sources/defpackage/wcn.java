...
public final class wcn extends wck implements ekhu, fbas, ekhq, ekkk, elar {
    private wcp ag;
    private Context ai;
    ...
    @Override // defpackage.wck, defpackage.efae, defpackage.ea
    ...
    @Override // defpackage.wck, defpackage.dn, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.ag == null) {
                try {
                    Object aX = aX();
                    fbbf fbbfVar = ((akgt) aX).D;
                    fbbf fbbfVar2 = ((akgt) aX).F;
                    akis akisVar = ((akgt) aX).a;
                    fbbf fbbfVar3 = akisVar.aJ;
                    fbbf fbbfVar4 = akisVar.b.oJ;
                    fbbf fbbfVar5 = ((akgt) aX).G;
                    Bundle a = ((akgt) aX).a();
                    ...
                    wcu wcuVar = (wcu) ProtoParsers.f(a, "TIKTOK_FRAGMENT_ARGUMENT", wcu.a, eyfcVar);
                    wcuVar.getClass();
                    this.ag = new wcp(fbbfVar, fbbfVar2, fbbfVar3, fbbfVar4, fbbfVar5, wcuVar);
    ...
    public final Dialog hf(Bundle bundle) {
        super.hf(bundle);
        final wcp H = H();
        ekji ekjiVar = (ekji) H.b.b();
        ehft ehftVar = new ehft(ekjiVar);
        ehftVar.n(ekjiVar.getString(R.string.remove_user_dialog_message, new Object[]{H.f}));
        ehftVar.o(R.string.remove_user_dialog_cancel, new elbb((elbx) H.c.b(), "RemoveUserDialog Cancel", new DialogInterface.OnClickListener() { // from class: wco
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                wcp.this.a.hw();
            }
        }));
        ehftVar.t(R.string.remove_user_dialog_confirm, new elll((ellq) H.d.b(), new wcp.a()));
    ...
    @Override // defpackage.wck, defpackage.ea
