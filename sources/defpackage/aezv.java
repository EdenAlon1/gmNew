...
public final class aezv implements aezz {
    ...
    public final aezy a(aezx aezxVar) {
        ...
        if (!bdtd.m(aezfVar.a)) {
            return (aezy) Collection.EL.stream(aezfVar.c).filter(new Predicate() { // from class: aezr
            ...
            }).max(Comparator.CC.comparing(new Function() { // from class: aezs
            ...
            })).map(new Function() { // from class: aezt
                @Override // java.util.function.Function
                /* renamed from: andThen */
                public final /* synthetic */ Function mo448andThen(Function function) {
                    return Function$CC.$default$andThen(this, function);
                ...
                public final Object apply(Object obj) {
                    ...
                    return new aezg(aezv.this.a.a(classificationResult.b()), classificationResult.a(), classificationResult.b());
                }

                public final /* synthetic */ Function compose(Function function) {
                    return Function$CC.$default$compose(this, function);
                }
            }).orElseGet(new Supplier() { // from class: aezu
