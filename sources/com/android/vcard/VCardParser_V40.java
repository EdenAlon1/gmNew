...
public class VCardParser_V40 extends VCardParser {
    ...
    public static final Set<String> valueListParameters = enip.s("PID", VCardConstants.PARAM_TYPE, VCardConstants.PARAM_SORT_AS);
    private final qnf mVCardParserImpl;

    public VCardParser_V40() {
        this.mVCardParserImpl = new qnf();
    }
    ...
    public VCardParser_V40(int i) {
        this.mVCardParserImpl = new qnf(null);
    }
}
