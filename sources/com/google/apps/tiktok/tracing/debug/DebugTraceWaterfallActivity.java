...
import defpackage.elih;
import defpackage.elii;
import defpackage.eliu;
...
public final class DebugTraceWaterfallActivity extends eliu implements ekhu, ekhr, ekke {
    private elih o;
    private boolean q;
    private Context r;
    private lkv t;
    ...
    private final void E() {
        if (this.o == null) {
            ...
            try {
                ...
                try {
                    try {
                        this.o = new elih((Activity) ((akgb) aX()).d.b());
                        f.close();
    ...
    @Override // defpackage.eliu, defpackage.efac, defpackage.eg, defpackage.abe, defpackage.hl, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            E();
            elih elihVar = this.o;
            eljy eljyVar = elihVar.b.c;
            if (eljyVar == null) {
                eljyVar = eljy.a;
            }
            elihVar.a.setTitle(eljyVar.d);
            elihVar.a.k().setSubtitle((eljyVar.f - eljyVar.e) + "ms");
            if (bundle == null) {
                elka elkaVar = elihVar.b;
                elii eliiVar = new elii();
                fbae.e(eliiVar);
                ekku.a(eliiVar, elkaVar);
                cg cgVar = new cg(elihVar.a.a());
                cgVar.s(R.id.content, eliiVar);
                cgVar.c();
            }
            this.q = false;
            this.p.m();
    ...
    @Override // defpackage.eliu, defpackage.efac, defpackage.iy, defpackage.eg, android.app.Activity
