...
import defpackage.ehry;
import defpackage.ehrz;
import defpackage.ehsa;
import defpackage.ehsb;
...
import defpackage.elbk;
import defpackage.elbx;
import defpackage.eldl;
import defpackage.eleg;
import defpackage.elfd;
import defpackage.elfe;
import defpackage.elhx;
import defpackage.elhy;
import defpackage.elhz;
import defpackage.elir;
...
public final class DebugTraceActivity extends elir implements ekhu, ekhr, ekke {
    private elhy o;
    private boolean q;
    private Context r;
    private lkv t;
        ...
        if (this.o == null) {
            ...
            try {
                ...
                try {
                    try {
                        Object aX = aX();
                        this.o = new elhy((eg) ((akgb) aX).f.b(), (eljl) ((akgb) aX).b.b.oI.b(), (elbx) ((akgb) aX).b.aJ.b(), new elfe((elbx) ((akgb) aX).b.aJ.b()));
                        f.close();
    ...
    @Override // defpackage.elir, defpackage.efac, defpackage.eg, defpackage.abe, defpackage.hl, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            E.a.setContentView(R.layout.debug_trace_activity);
            View findViewById = E.a.findViewById(R.id.debug_trace_container);
            kud kudVar = new kud() { // from class: elhw
            ...
            E.e = (ViewPager2) E.a.findViewById(R.id.pager);
            elhx elhxVar = new elhx(E.a);
            ViewPager2 viewPager2 = E.e;
            vk vkVar = viewPager2.f.n;
            pee peeVar = viewPager2.j;
            if (vkVar != null) {
                vkVar.C(((pel) peeVar).a);
            }
            if (vkVar != null) {
                vkVar.C(viewPager2.d);
            }
            viewPager2.f.am(elhxVar);
            viewPager2.b = 0;
            viewPager2.e();
            pee peeVar2 = viewPager2.j;
            ((pel) peeVar2).c();
            elhxVar.A(((pel) peeVar2).a);
            elhxVar.A(viewPager2.d);
            elhxVar.f.a.add(new elfd(E.d));
            TabLayout tabLayout = (TabLayout) E.a.findViewById(R.id.tabs);
            tabLayout.s(0);
            ehsb ehsbVar = new ehsb(tabLayout, E.e);
            if (ehsbVar.d) {
                throw new IllegalStateException("TabLayoutMediator is already attached");
            }
            ehsbVar.c = ehsbVar.b.c();
            if (ehsbVar.c == null) {
                throw new IllegalStateException("TabLayoutMediator attached before ViewPager2 has an adapter");
            }
            ehsbVar.d = true;
            ehsbVar.e = new ehrz(ehsbVar.a);
            ehsbVar.b.d(ehsbVar.e);
            ehsbVar.f = new ehsa(ehsbVar.b);
            ehsbVar.a.f(ehsbVar.f);
            ehsbVar.g = new ehry(ehsbVar);
            ehsbVar.c.A(ehsbVar.g);
            ehsbVar.a();
            ehsbVar.a.x(ehsbVar.b.b);
            ellg.a(this).b = findViewById(android.R.id.content);
            ellj.a(this, eljo.a.class, new elhz(this.o));
            this.q = false;
            this.p.m();
            t.close();
        } catch (Throwable th) {
    ...
    public final boolean onCreateOptionsMenu(Menu menu) {
        ...
        final elhy E = E();
        menu.add("Clear traces").setOnMenuItemClickListener(new elbk(E.c, "Clearing traces", new MenuItem.OnMenuItemClickListener() { // from class: elhv
            @Override // android.view.MenuItem.OnMenuItemClickListener
            public final boolean onMenuItemClick(MenuItem menuItem) {
                Runtime.getRuntime().gc();
                Runtime.getRuntime().runFinalization();
                eljl eljlVar = elhy.this.b;
                ListenableFuture e = eljlVar.a.c.e(new efkr() { // from class: eljf
                    @Override // defpackage.efkr
                    public final void a(efks efksVar) {
                        int i = eljg.d;
                        efksVar.b("tracing", "1", new String[0]);
                    }
                });
                eljlVar.c.a(e, "DebugTraceRow");
                eljlVar.c.a(e, "DebugTraceData");
                return true;
            }
        }));
        return true;
    ...
    @Override // defpackage.elir, defpackage.efac, defpackage.iy, defpackage.eg, android.app.Activity
