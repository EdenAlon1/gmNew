...
public interface IEnsureSupervisionSetupCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IEnsureSupervisionSetupCallback {
        ...
        public static IEnsureSupervisionSetupCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.kids.internal.IEnsureSupervisionSetupCallback");
            return queryLocalInterface instanceof IEnsureSupervisionSetupCallback ? (IEnsureSupervisionSetupCallback) queryLocalInterface : new Proxy(iBinder);
        }
