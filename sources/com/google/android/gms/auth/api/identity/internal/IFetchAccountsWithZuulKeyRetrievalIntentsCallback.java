...
public interface IFetchAccountsWithZuulKeyRetrievalIntentsCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IFetchAccountsWithZuulKeyRetrievalIntentsCallback {
        ...
        public static IFetchAccountsWithZuulKeyRetrievalIntentsCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.identity.internal.IFetchAccountsWithZuulKeyRetrievalIntentsCallback");
            return queryLocalInterface instanceof IFetchAccountsWithZuulKeyRetrievalIntentsCallback ? (IFetchAccountsWithZuulKeyRetrievalIntentsCallback) queryLocalInterface : new Proxy(iBinder);
        }
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            ArrayList createTypedArrayList = parcel.createTypedArrayList(AccountWithZuulKeyRetrievalIntent.CREATOR);
