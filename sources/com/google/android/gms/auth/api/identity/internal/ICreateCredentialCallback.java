...
public interface ICreateCredentialCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements ICreateCredentialCallback {
        ...
        public static ICreateCredentialCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.identity.internal.ICreateCredentialCallback");
            return queryLocalInterface instanceof ICreateCredentialCallback ? (ICreateCredentialCallback) queryLocalInterface : new Proxy(iBinder);
        }
