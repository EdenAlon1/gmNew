...
public interface IListSignInCredentialsCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IListSignInCredentialsCallback {
        ...
        public static IListSignInCredentialsCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.identity.internal.IListSignInCredentialsCallback");
            return queryLocalInterface instanceof IListSignInCredentialsCallback ? (IListSignInCredentialsCallback) queryLocalInterface : new Proxy(iBinder);
        }
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            ArrayList createTypedArrayList = parcel.createTypedArrayList(InternalSignInCredentialWrapper.CREATOR);
