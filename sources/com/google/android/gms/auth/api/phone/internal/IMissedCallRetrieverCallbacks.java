...
public interface IMissedCallRetrieverCallbacks extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IMissedCallRetrieverCallbacks {
        ...
        public static IMissedCallRetrieverCallbacks asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.phone.internal.IMissedCallRetrieverCallbacks");
            return queryLocalInterface instanceof IMissedCallRetrieverCallbacks ? (IMissedCallRetrieverCallbacks) queryLocalInterface : new Proxy(iBinder);
        }
