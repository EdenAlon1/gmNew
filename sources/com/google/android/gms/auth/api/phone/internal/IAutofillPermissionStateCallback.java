...
public interface IAutofillPermissionStateCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IAutofillPermissionStateCallback {
        ...
        public static IAutofillPermissionStateCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.phone.internal.IAutofillPermissionStateCallback");
            return queryLocalInterface instanceof IAutofillPermissionStateCallback ? (IAutofillPermissionStateCallback) queryLocalInterface : new Proxy(iBinder);
        }
