...
public class Configurations extends AbstractSafeParcelable {
    public static final Parcelable.Creator<Configurations> CREATOR = new dhjw();
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof Configurations) {
            ...
            if (dhlg.a(this.a, configurations.a) && dhlg.a(this.c, configurations.c) && this.e.equals(configurations.e) && this.f == configurations.f && Arrays.equals(this.b, configurations.b) && this.g == configurations.g) {
                return true;
            }
        }
        return false;
