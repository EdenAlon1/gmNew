...
public final class AutoValue_SendMessageRequest extends SendMessageRequest {
    ...
    private final eigz g;

    public AutoValue_SendMessageRequest(PendingIntent pendingIntent, com.google.android.rcs.client.messaging.data.Conversation conversation, Message message, MessageClass messageClass, TraceId traceId, Optional optional, eigz eigzVar) {
    ...
    @Override // com.google.android.rcs.client.messaging.SendMessageRequest, defpackage.eiaa
    ...
    public final String toString() {
        ...
        return "SendMessageRequest{intent=" + this.a.toString() + ", conversation=" + conversation.toString() + ", message=" + message.toString() + ", messageClass=" + messageClass.toString() + ", traceId=" + traceId.toString() + ", opaqueData=" + String.valueOf(optional) + ", messagingMethod=" + eigzVar.toString() + "}";
    }
}
