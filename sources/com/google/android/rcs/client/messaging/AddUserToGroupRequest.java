...
public abstract class AddUserToGroupRequest implements Parcelable, eiaa {
    public static final Parcelable.Creator<AddUserToGroupRequest> CREATOR = new ehxs();
    ...
    public final void writeToParcel(final Parcel parcel, int i) {
        ...
        d().ifPresent(new Consumer() { // from class: ehxr
