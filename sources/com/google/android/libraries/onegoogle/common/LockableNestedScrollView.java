...
public final class LockableNestedScrollView extends NestedScrollView {
    ...
    @Override // androidx.core.widget.NestedScrollView, defpackage.kua
    public final boolean u(View view, View view2, int i, int i2) {
        view.getClass();
        view2.getClass();
        return this.h && super.u(view, view2, i, i2);
    }
    ...
    public /* synthetic */ LockableNestedScrollView(Context context, AttributeSet attributeSet, int i, ffkd ffkdVar) {
