...
import defpackage.egjd;
import defpackage.egje;
...
public class SquareImageView extends View {
    ...
    public SquareImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        try {
            ...
            if (fdrj.c()) {
                TypedArray obtainStyledAttributes2 = context.getTheme().obtainStyledAttributes(attributeSet, egjd.a, 0, 0);
                try {
