...
public final class BusinessInfoContentProvider extends cbfy<BusinessInfoContentProviderInternal> {
    ...
    public static final class BusinessInfoContentProviderInternal extends ContentProvider {
        ...
        public static Uri buildBusinessInfoPropertiesUri(String str, Context context) {
            if (dkuy.k(context)) {
                dkty.k("Building CS business info properties URI for botId: %s", dkty.a(str));
                return CSAPK_BUSINESS_INFO_PROPERTIES_URI.buildUpon().appendPath(str).build();
            }
            dkty.k("Building AM business info properties URI for botId: %s", dkty.a(str));
        ...
        public static Uri buildBusinessInfoUri(String str, Context context) {
            if (dkuy.k(context)) {
                dkty.k("Building CS business info URI for botId: %s", dkty.a(str));
                return CSAPK_BUSINESS_INFO_URI.buildUpon().appendPath(str).build();
            }
            dkty.k("Building AM business info URI for botId: %s", dkty.a(str));
        ...
        public static void notifyBusinessInfoChanged(Context context, String str) {
            dkty.k("Notifying business info changed for botId %s", dkty.a(str));
        ...
        public static void notifyBusinessInfoPropertiesChanged(Context context, String str) {
            dkty.k("Notifying business info properties changed for botId %s", dkty.a(str));
        ...
        public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
            ...
            try {
                ...
                if (match == 10) {
                    ...
                    if (match != 20) {
                        csix.c("Unknown BusinessInfoContentProvider query URI ".concat(String.valueOf(String.valueOf(uri))));
                        return null;
                    }
                ...
                dkty.q("Calling package is not whitelisted.", new Object[0]);
                return null;
            }
        }
