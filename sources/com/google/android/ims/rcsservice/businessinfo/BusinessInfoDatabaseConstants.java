...
public class BusinessInfoDatabaseConstants {
    ...
    public static final class BusinessInfoAndVerifierInfoViewConstants {
        ...
        static {
            ...
            engrVar.j(Arrays.asList(BusinessInfoTableConstants.PROJECTION_WITHOUT_ID));
            engrVar.i(Columns.VERIFIER_NAME, Columns.VERIFIER_LOGO_IMAGE_REMOTE_URL, Columns.VERIFIER_LOGO_IMAGE_LOCAL_URI);
            DEFAULT_PROJECTION = (String[]) engrVar.g().toArray(new String[0]);
        }
    ...
    public static final class BusinessInfoTableConstants {
        ...
        static {
            ...
            engr engrVar = new engr();
            engrVar.h("_id");
            engrVar.j(Arrays.asList(strArr));
            DEFAULT_PROJECTION = (String[]) engrVar.g().toArray(new String[0]);
        }
    }
