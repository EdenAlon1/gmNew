...
public interface ITarsService extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements ITarsService {
        ...
        public static class Proxy extends BaseProxy implements ITarsService {
            ...
            @Override // com.google.android.apps.aicore.aidl.ITarsService
            public ICancellationCallback runCancellableInference(rzl rzlVar, ITarsResultCallback iTarsResultCallback) {
                Parcel obtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
                rve.d(obtainAndWriteInterfaceToken, rzlVar);
                rve.f(obtainAndWriteInterfaceToken, iTarsResultCallback);
        ...
        public static ITarsService asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.apps.aicore.aidl.ITarsService");
            return queryLocalInterface instanceof ITarsService ? (ITarsService) queryLocalInterface : new Proxy(iBinder);
        }

        @Override // com.google.android.aidl.BaseStub
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            if (i == 2) {
                rzl rzlVar = (rzl) rve.a(parcel, rzl.CREATOR);
                ITarsResultCallback asInterface = ITarsResultCallback.Stub.asInterface(parcel.readStrongBinder());
                enforceNoDataAvail(parcel);
                ICancellationCallback runCancellableInference = runCancellableInference(rzlVar, asInterface);
    ...
    ICancellationCallback runCancellableInference(rzl rzlVar, ITarsResultCallback iTarsResultCallback);
}
