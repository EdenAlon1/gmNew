...
public final class SignOutAccountActivity extends adnu implements ekhu, ekhr, ekke {
    private boolean L;
    private Context M;
    private lkv O;
    private boolean P;
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof SignOutAccountActivity)) {
                        throw new IllegalStateException(a.I(activity, adob.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    SignOutAccountActivity signOutAccountActivity = (SignOutAccountActivity) activity;
                    signOutAccountActivity.getClass();
                    this.n = new adob(signOutAccountActivity, ((akgb) aX).w, ((akgb) aX).x, ((akgb) aX).ad, ((akgb) aX).b.a.RR);
                    f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            adob adobVar = this.n;
            ellj.a(this, ains.class, new adoc(adobVar));
            ellj.a(this, aijd.class, new adod(adobVar));
            this.L = false;
            this.K.m();
            t.close();
        } catch (Throwable th) {
