...
public final class PrivacySettingsActivity extends ajlf implements ekhu, ekhr, ekke {
    private ajli K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof PrivacySettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, ajli.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        PrivacySettingsActivity privacySettingsActivity = (PrivacySettingsActivity) activity;
                        privacySettingsActivity.getClass();
                        this.K = new ajli(privacySettingsActivity, (bzqa) ((akgb) aX).b.cI.b(), (caao) ((akgb) aX).b.lz.b());
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            TextView textView = (TextView) M.a.findViewById(R.id.privacy_preference_info_text_id);
            ...
            if (M.b.q()) {
                ...
                if (!TextUtils.isEmpty(d)) {
                    ...
                    final Uri a2 = ddyi.a(d, context);
                    textView.setOnClickListener(new View.OnClickListener() { // from class: ajlh
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            ajli.this.a.startActivity(new Intent("android.intent.action.VIEW").setData(a2));
                        }
                    });
                }
            ...
            fbae.e(ajljVar);
            cgVar.E(R.id.privacy_preference_fragment_container, ajljVar);
            cgVar.c();
            this.M = false;
            this.L.m();
            t.close();
