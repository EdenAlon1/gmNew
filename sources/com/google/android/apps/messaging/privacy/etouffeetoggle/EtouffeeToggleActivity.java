...
public final class EtouffeeToggleActivity extends ajkf implements ekhu, ekhr, ekke {
    private ajjt K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof EtouffeeToggleActivity)) {
                            throw new IllegalStateException(a.I(activity, ajjt.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.K = new ajjt(etouffeeToggleActivity, akisVar.cI, akisVar.lz);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            TextView textView = (TextView) M.a.findViewById(R.id.etouffee_toggle_info_text_id);
            Context context = textView.getContext();
            if (((bzqa) M.b.b()).q()) {
                EtouffeeToggleActivity etouffeeToggleActivity = M.a;
                ...
                String f = ((bzqa) M.b.b()).f();
                if (!TextUtils.isEmpty(f)) {
                    String a = crmi.a(context);
                    spannableStringBuilder = ddyi.f(context, spannableStringBuilder.append((CharSequence) "\n\n").append((CharSequence) a).toString(), a);
                    final Uri a2 = ddyi.a(f, context);
                    textView.setOnClickListener(new View.OnClickListener() { // from class: ajjs
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            ajjt.this.a.startActivity(new Intent("android.intent.action.VIEW").setData(a2));
                        }
                    });
                }
            ...
            fbae.e(ajjuVar);
            cgVar.E(R.id.etouffee_toggle_fragment_container, ajjuVar);
            cgVar.c();
            this.M = false;
            this.L.m();
            t.close();
