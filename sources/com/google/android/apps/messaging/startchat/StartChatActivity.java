...
public final class StartChatActivity extends cvqk implements ekhu, ekhr, ekke {
    private boolean L;
    private Context M;
    private lkv O;
    private boolean P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof StartChatActivity)) {
                            throw new IllegalStateException(a.I(activity, cvqm.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        StartChatActivity startChatActivity = (StartChatActivity) activity;
                        startChatActivity.getClass();
                        this.n = new cvqm(startChatActivity, ((akgb) aX).w, ((akgb) aX).x);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            ellj.a(this, aijd.class, new cvqn(this.n));
            this.L = false;
            this.K.m();
            t.close();
        } catch (Throwable th) {
