...
public final class InfoAndOptionsActivity extends wah implements ekhu, ekhr, ekke {
    private boolean L;
    private Context M;
    private lkv O;
    private boolean P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof InfoAndOptionsActivity)) {
                            throw new IllegalStateException(a.I(activity, wam.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        InfoAndOptionsActivity infoAndOptionsActivity = (InfoAndOptionsActivity) activity;
                        infoAndOptionsActivity.getClass();
                        this.n = new wam(infoAndOptionsActivity);
                        f.close();
    ...
    protected final ea G(vzi vziVar) {
        wam M = M();
        wau wauVar = (wau) wav.a.createBuilder();
        wauVar.copyOnWrite();
        wav wavVar = (wav) wauVar.instance;
        vziVar.getClass();
        wavVar.c = vziVar;
        wavVar.b |= 1;
        String stringExtra = M.a.getIntent().getStringExtra("rbm_bot_id");
        stringExtra.getClass();
        wauVar.copyOnWrite();
        ((wav) wauVar.instance).d = stringExtra;
        wav wavVar2 = (wav) wauVar.build();
        wat watVar = new wat();
        fbae.e(watVar);
        ekku.a(watVar, wavVar2);
        return watVar;
    }
    ...
    @Override // defpackage.vzf, defpackage.cwqd, defpackage.cwpv, defpackage.cwps, defpackage.cwqf, defpackage.efac, defpackage.eg, defpackage.abe, defpackage.hl, android.app.Activity
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            Toolbar toolbar = ((cwqd) infoAndOptionsActivity).G;
            if (toolbar != null) {
                toolbar.setElevation(0.0f);
                ((cwqd) infoAndOptionsActivity).G.invalidate();
            }
            this.L = false;
            this.K.m();
            t.close();
