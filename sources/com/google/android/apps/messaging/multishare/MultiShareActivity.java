...
public final class MultiShareActivity extends ahtq implements ekhu, ekhr, ekke {
    private boolean L;
    private Context M;
    private lkv O;
    private boolean P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof MultiShareActivity)) {
                            throw new IllegalStateException(a.I(activity, ahts.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        MultiShareActivity multiShareActivity = (MultiShareActivity) activity;
                        multiShareActivity.getClass();
                        this.n = new ahts(multiShareActivity, ((akgb) aX).w, ((akgb) aX).x);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            ellj.a(this, aijd.class, new ahtt(this.n));
            this.L = false;
            this.K.m();
            t.close();
        } catch (Throwable th) {
