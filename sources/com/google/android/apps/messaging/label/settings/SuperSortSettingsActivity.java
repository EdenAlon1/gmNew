...
public final class SuperSortSettingsActivity extends ahhi implements ekhu, ekhr, ekke {
    private ahhy K;
    private boolean M;
    private Context N;
    private lkv P;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof SuperSortSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, ahhy.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        SuperSortSettingsActivity superSortSettingsActivity = (SuperSortSettingsActivity) activity;
                        superSortSettingsActivity.getClass();
                        this.K = new ahhy(superSortSettingsActivity, ((akgb) aX).b.a.dG);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            fbae.e(ahicVar);
            cgVar.E(R.id.fragment_container, ahicVar);
            cgVar.c();
            this.M = false;
            this.L.m();
            t.close();
    ...
    protected final void onStop() {
        ...
        try {
            super.onStop();
            ahhy M = M();
            if (M.a.getIntent().getBooleanExtra("extra_open_settings_from_consent", false)) {
                axnw.h(((ahik) M.b.b()).f());
            }
            j.close();
        } catch (Throwable th) {
