...
public final class MessageOrganizationSettingsActivity extends ahhf implements ekhu, ekhr, ekke {
    private ahhk K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof MessageOrganizationSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, ahhk.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.K = new ahhk(messageOrganizationSettingsActivity);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            fbae.e(ahhlVar);
            cgVar.E(R.id.fragment_container, ahhlVar);
            cgVar.c();
            this.M = false;
            this.L.m();
            t.close();
