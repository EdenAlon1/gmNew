...
public final class ArchivedActivity extends adzv implements ekhu, ekhr, ekke {
    private boolean L;
    private Context M;
    private lkv O;
    private boolean P;
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof ArchivedActivity)) {
                        throw new IllegalStateException(a.I(activity, adzn.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    ...
                    fbbf fbbfVar2 = ((akgb) aX).x;
                    akis akisVar = ((akgb) aX).b;
                    akko akkoVar = akisVar.b;
                    this.n = new adzn(archivedActivity, ddwpVar, fbbfVar, fbbfVar2, akkoVar.jB, akkoVar.kG, akisVar.a.RR);
                    f.close();
                    this.n.e = this;
    ...
    protected final void fx(im imVar) {
        super.fx(imVar);
        adzn M = M();
        ArchivedActivity archivedActivity = M.a;
        Toolbar eZ = archivedActivity.eZ();
        ddwp ddwpVar = M.d;
        adzp.b(archivedActivity, eZ, imVar, R.string.archived_activity_title, ((aubf) M.b.b()).a());
    }
