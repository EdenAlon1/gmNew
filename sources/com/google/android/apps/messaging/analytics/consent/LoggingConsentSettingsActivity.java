...
public final class LoggingConsentSettingsActivity extends sew implements ekhu, ekhr, ekke {
    private sfd K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof LoggingConsentSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, sfd.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.K = new sfd(loggingConsentSettingsActivity);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            sfe sfeVar = new sfe();
            fbae.e(sfeVar);
            cgVar.E(R.id.logging_consent_preference_fragment_container, sfeVar);
            cgVar.c();
            this.M = false;
            this.L.m();
            t.close();
