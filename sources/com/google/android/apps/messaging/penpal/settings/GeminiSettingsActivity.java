...
public final class GeminiSettingsActivity extends ajfn implements ekhu, ekhr, ekke {
    private ajff K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof GeminiSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, ajff.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        GeminiSettingsActivity geminiSettingsActivity = (GeminiSettingsActivity) activity;
                        geminiSettingsActivity.getClass();
                        this.K = new ajff(geminiSettingsActivity);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            fbae.e(ajfgVar);
            cgVar.E(R.id.fragment_container, ajfgVar);
            cgVar.c();
            this.M = false;
            this.L.m();
            t.close();
