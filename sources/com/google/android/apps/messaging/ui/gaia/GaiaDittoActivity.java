...
public final class GaiaDittoActivity extends dbvb implements ekhu, ekhr, ekke {
    private boolean L;
    private Context M;
    private lkv O;
    private boolean P;
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof GaiaDittoActivity)) {
                        throw new IllegalStateException(a.I(activity, dbtp.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    ...
                    this.n = new dbtp(gaiaDittoActivity, fbbfVar, akkpVar.Uk, ((akgb) aX).x, ((akgb) aX).ac, akkpVar.C, akkpVar.RR, akisVar.b.kX);
                    f.close();
                    this.n.g = this;
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            M();
            dbtp dbtpVar = this.n;
            if (((auxx) dbtpVar.e.b()).a()) {
                abh.a(dbtpVar.b);
            }
            dbtpVar.b.setContentView(true != ((auya) dbtpVar.f.b()).a() ? R.layout.gaia_ditto_activity : R.layout.gaia_ditto_activity_coolranch);
            if (bundle == null) {
                ((akzt) dbtpVar.d.b()).c("Bugle.Gaia.Pairing.Seen");
            }
            this.L = false;
            this.K.m();
            t.close();
