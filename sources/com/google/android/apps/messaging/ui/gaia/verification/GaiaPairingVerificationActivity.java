...
public final class GaiaPairingVerificationActivity extends dbwi implements ekhu, ekhr, ekke {
    private boolean A;
    private dbvp n;
    private boolean p;
    private Context q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof GaiaPairingVerificationActivity)) {
                            throw new IllegalStateException(a.I(activity, dbvp.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.n = new dbvp(gaiaPairingVerificationActivity, akkpVar.zL, Optional.of((bzme) akkpVar.zK.b()));
                        f.close();
    ...
    /* JADX WARN: Type inference failed for: r8v16, types: [bzme, java.lang.Object] */
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            dbvp J = J();
            cg cgVar = new cg(J.b.a());
            dbvr dbvrVar = new dbvr();
            fbae.e(dbvrVar);
            cgVar.s(R.id.content, dbvrVar);
            cgVar.c();
            if (bundle == null) {
                ensz enszVar = (ensz) dbvp.a.h();
                enszVar.Y(csux.O, J.getClass().getSimpleName());
                enszVar.q("Gaia pairing verification prompt created");
                int intExtra = J.b.getIntent().getIntExtra("prompt_launch_source", 0);
                ensz enszVar2 = (ensz) dbvp.a.h();
                enszVar2.Y(csux.O, J.getClass().getSimpleName());
                enszVar2.r("launch source: %s", intExtra);
                bznq bznqVar = (bznq) J.c.b();
                if (intExtra != 0) {
                    i = 3;
                    if (intExtra != 1) {
                ...
                if (bznqVar.d.a()) {
                    axol.c(bznqVar.e, ffhe.a, ffsm.a, new bzno(bznqVar, i, null));
                } else {
                    ((bzea) bznqVar.a.b()).x(2, (String) ((cgvp) bznqVar.b.b()).a.get(), i);
                }
                J.d.isPresent();
                J.d.get().k();
            }
