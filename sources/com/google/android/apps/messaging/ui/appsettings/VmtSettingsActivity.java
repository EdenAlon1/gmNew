...
import defpackage.cwxe;
import defpackage.cxjp;
...
public final class VmtSettingsActivity extends cwxe implements ekhu, ekhr, ekke {
    private cxjp K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof VmtSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, cxjp.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        VmtSettingsActivity vmtSettingsActivity = (VmtSettingsActivity) activity;
                        vmtSettingsActivity.getClass();
                        this.K = new cxjp(vmtSettingsActivity, Optional.of(((akgb) aX).b.a.p()));
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            final cxjp M = M();
            Optional optional = M.b;
            final ffji ffjiVar = new ffji() { // from class: cxjn
                @Override // defpackage.ffji
                public final Object invoke(Object obj) {
                    ((sid) obj).getClass();
                    cxjp cxjpVar = cxjp.this;
                    cxjpVar.a.setTitle(R.string.vmt_preference_page_title);
                    ((TextView) cxjpVar.a.findViewById(R.id.vmt_preferences_education)).setText(R.string.vmt_preference_page_education);
                    cg cgVar = new cg(cxjpVar.a.a());
                    cxjq cxjqVar = new cxjq();
                    fbae.e(cxjqVar);
                    cgVar.E(R.id.vmt_preferences_fragment_container, cxjqVar);
                    cgVar.c();
                    return ffcu.a;
                }
            };
            optional.ifPresent(new Consumer() { // from class: cxjo
