...
public final class SpamSettingsActivity extends cwwv implements ekhu, ekhr, ekke {
    private cxho K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof SpamSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, cxho.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        SpamSettingsActivity spamSettingsActivity = (SpamSettingsActivity) activity;
                        spamSettingsActivity.getClass();
                        this.K = new cxho(spamSettingsActivity, (akvg) ((akgb) aX).b.a.Px.b(), (adtc) ((akgb) aX).c.bt.b(), ((akgb) aX).aZ);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            TextView textView = (TextView) M.c.findViewById(R.id.spam_preference_fragment_container_text_view);
            textView.setOnClickListener(new View.OnClickListener() { // from class: cxhn
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    String str = (String) cxho.b.e();
                    String str2 = (String) cxho.a.e();
                    if (TextUtils.isEmpty(str) && TextUtils.isEmpty(str2)) {
                        return;
                    }
                    cxho cxhoVar = cxho.this;
                    if (cubs.e()) {
                        ((alef) cxhoVar.f.b()).c(2, 3);
                    }
                    if (TextUtils.isEmpty(str)) {
                        cxhoVar.d.y(cxhoVar.c, str2);
                    } else {
                        cxhoVar.e.e(cxhoVar.c, str);
                    }
                }
            });
