...
public final class RichCardsSettingsActivity extends cwwi implements ekhu, ekhr, ekke {
    private cxcz K;
    private boolean M;
    private Context N;
    private lkv P;
    ...
    private final void N() {
        ...
        try {
            ...
            try {
                try {
                    Object aX = aX();
                    this.K = new cxcz(((akgb) aX).ab(), (akvg) ((akgb) aX).b.a.Px.b(), ((akgb) aX).ab(), ((akgb) aX).w, ((akgb) aX).x);
                    f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            TextView textView = (TextView) M.b.findViewById(R.id.rich_cards_preference_info_text_id);
            textView.setOnClickListener(new View.OnClickListener() { // from class: cxcx
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    String str = (String) cful.y.e();
                    cxcz cxczVar = cxcz.this;
                    cxczVar.a.y(cxczVar.b, str);
                }
            });
            SpannableStringBuilder d = ddyi.d(M.b, R.string.new_rich_cards_preference_info_text);
            textView.setText(d);
