...
import defpackage.cxij;
import defpackage.ehdq;
...
public final class SwipeActionSettingsActivity extends cwwy implements ekhu, ekhr, ekke {
    private cxhx K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof SwipeActionSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, cxhx.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.K = new cxhx(swipeActionSettingsActivity);
                        f.close();
    ...
    @Override // defpackage.aktz, defpackage.cwqd, defpackage.cwpv, defpackage.cwps
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            im k = M.a.k();
            if (ehdq.a()) {
                M.a.setTheme(R.style.ThemeOverlay_SwipeActionSettingsActivity_DynamicColors_DayNight);
            }
            String string = M.a.getString(R.string.swipe_actions);
            if (!TextUtils.isEmpty(string)) {
                cwpw.b(k, string);
            }
            cg cgVar = new cg(M.a.a());
            cxij cxijVar = new cxij();
            fbae.e(cxijVar);
            cgVar.E(R.id.fragment_container, cxijVar);
            cgVar.c();
            this.M = false;
            this.L.m();
            t.close();
