...
public final class TurnOffRcsActivity extends cwxb implements ekhu, ekhr, ekke {
    private boolean L;
    private Context M;
    private lkv O;
    private boolean P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof TurnOffRcsActivity)) {
                            throw new IllegalStateException(a.I(activity, cxix.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        TurnOffRcsActivity turnOffRcsActivity = (TurnOffRcsActivity) activity;
                        turnOffRcsActivity.getClass();
                        this.n = new cxix(turnOffRcsActivity);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            fbae.e(cxiyVar);
            cg cgVar = new cg(cxixVar.a.a());
            cgVar.s(R.id.content, cxiyVar);
            cgVar.c();
            this.L = false;
            this.K.m();
            t.close();
