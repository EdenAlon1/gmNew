...
import defpackage.epgr;
import defpackage.epgt;
...
public final class RcsSettingsActivity extends cwwf implements ekhu, ekhr, ekke {
    private cxbf K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof RcsSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, cxbf.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        RcsSettingsActivity rcsSettingsActivity = (RcsSettingsActivity) activity;
                        rcsSettingsActivity.getClass();
                        this.K = new cxbf(rcsSettingsActivity, (akzt) ((akgb) aX).b.a.f.b(), ((akgb) aX).b.a.fP);
                        f.close();
    ...
    protected final void onActivityResult(int i, int i2, Intent intent) {
        ...
        try {
            ...
            ea g = M().a.a().g(R.id.fragment_container);
            if (g != null) {
                g.af(i, i2, intent);
            }
            r.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (k != null) {
                ...
                k.setTitle(R.string.rcs_settings_activity_title_v2);
            }
            if (bundle == null) {
                String stringExtra = M.a.getIntent() != null ? M.a.getIntent().getStringExtra("open_setting_directly") : null;
                Bundle bundle2 = new Bundle();
                bundle2.putString("open_setting_directly", stringExtra);
                cg cgVar = new cg(M.a.a());
                cxbg cxbgVar = new cxbg();
                fbae.e(cxbgVar);
                cxbgVar.at(bundle2);
                cgVar.E(R.id.fragment_container, cxbgVar);
                cgVar.c();
                M.b.c("Bugle.UI.Settings.Advanced.Rcs");
                ((altk) M.c.b()).U(epgr.RCS_PROVISIONING_SETTINGS_CHAT_FEATURES_SCREEN_SEEN, epgt.PROVISIONING_UI_TYPE_SETTINGS_CHAT_FEATURES);
            }
            this.M = false;
            this.L.m();
            t.close();
