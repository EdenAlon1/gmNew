...
public final class VerifiedSmsSettingsActivity extends cxlq implements ekhu, ekhr, ekke {
    private cxlx K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof VerifiedSmsSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, cxlx.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.K = new cxlx(verifiedSmsSettingsActivity, (adtc) ((akgb) aX).c.bt.b());
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            final cxlx M = M();
            M.a.getWindow().setStatusBarColor(0);
            TextView textView = (TextView) M.a.findViewById(R.id.vsms_preference_info_text_id);
            textView.setOnClickListener(new View.OnClickListener() { // from class: cxlw
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    String str = (String) cful.ac.e();
                    cxlx cxlxVar = cxlx.this;
                    cxlxVar.b.e(cxlxVar.a, str);
                }
            });
            SpannableStringBuilder d = ddyi.d(M.a, R.string.verified_sms_user_setting_summary);
            textView.setText(d);
            textView.setContentDescription(d.toString());
            cg cgVar = new cg(M.a.a());
            cxly cxlyVar = new cxly();
            fbae.e(cxlyVar);
            cgVar.E(R.id.vsms_preference_fragment_container, cxlyVar);
            if (((Boolean) cuye.c.e()).booleanValue()) {
                M.a.findViewById(R.id.vsms_diagnostic_preference_fragment_container).setVisibility(0);
                TextView textView2 = (TextView) M.a.findViewById(R.id.vsms_diagnostic_preference_info_text_id);
                textView2.setVisibility(0);
                textView2.setOnClickListener(new View.OnClickListener() { // from class: cxlv
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        cxlx.this.a.startActivity(new Intent("android.intent.action.VIEW", Uri.parse((String) cuye.e.e())));
                    }
                });
                SpannableStringBuilder d2 = ddyi.d(M.a, R.string.verified_sms_diagnostic_report_setting_summary);
                textView2.setText(d2);
                textView2.setContentDescription(d2.toString());
                cxls cxlsVar = new cxls();
                fbae.e(cxlsVar);
                cgVar.E(R.id.vsms_diagnostic_preference_fragment_container, cxlsVar);
            }
            cgVar.j();
            this.M = false;
            this.L.m();
