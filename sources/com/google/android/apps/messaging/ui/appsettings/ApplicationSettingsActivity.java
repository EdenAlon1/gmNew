...
public final class ApplicationSettingsActivity extends cwvt implements ekhu, ekhr, ekke {
    private cwrv K;
    private boolean M;
    private Context N;
    private lkv P;
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof ApplicationSettingsActivity)) {
                        throw new IllegalStateException(a.I(activity, cwrv.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    ...
                    this.K = new cwrv(applicationSettingsActivity, (akzt) ((akgb) aX).b.a.f.b(), ((akgb) aX).w, ((akgb) aX).b.a.Uk, ((akgb) aX).x, Optional.empty());
                    f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cwrv M = M();
            im k = M.b.k();
            if (k != null && M.b.getIntent().getBooleanExtra("top_level_settings", false)) {
                cwpw.c(M.b, k, R.string.settings_activity_title);
            }
            M.a.c("Bugle.UI.Settings.Application");
            this.M = false;
            this.L.m();
            t.close();
        } catch (Throwable th) {
