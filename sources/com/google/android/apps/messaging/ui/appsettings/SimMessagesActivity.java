...
public final class SimMessagesActivity extends cwwn implements ekhu, ekhr, ekke {
    private boolean H;
    private Context I;
    private lkv K;
    private boolean L;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof SimMessagesActivity)) {
                            throw new IllegalStateException(a.I(activity, cxeq.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        SimMessagesActivity simMessagesActivity = (SimMessagesActivity) activity;
                        simMessagesActivity.getClass();
                        akkp akkpVar = ((akgb) aX).b.a;
                        this.n = new cxeq(simMessagesActivity, akkpVar.jc, akkpVar.f);
                        f.close();
                        this.n.e = this;
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cxeq N = N();
            cxeq.a(N.a);
            int intExtra = N.a.getIntent().getIntExtra("sub_id", -1);
            cg cgVar = new cg(N.a.a());
            String num = Integer.toString(intExtra);
            cxfj cxfjVar = new cxfj();
            fbae.e(cxfjVar);
            ekku.b(cxfjVar, num);
            cgVar.x(R.id.content, cxfjVar, "messages");
            cgVar.j();
            N.d = new cxep(N);
            N.a.gE().b(N.a, N.d);
            ((cins) N.b.b()).m();
            ((akzt) N.c.b()).c("Bugle.UI.Settings.Advanced.SimMessages");
            this.H = false;
            this.G.m();
            t.close();
        } catch (Throwable th) {
