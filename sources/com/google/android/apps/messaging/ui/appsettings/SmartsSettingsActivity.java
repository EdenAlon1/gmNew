...
public final class SmartsSettingsActivity extends cwws implements ekhu, ekhr, ekke {
    private cxga K;
    private boolean M;
    private Context N;
    private lkv P;
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof SmartsSettingsActivity)) {
                        throw new IllegalStateException(a.I(activity, cxga.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    SmartsSettingsActivity smartsSettingsActivity = (SmartsSettingsActivity) activity;
                    smartsSettingsActivity.getClass();
                    this.K = new cxga(smartsSettingsActivity, (akvg) ((akgb) aX).b.a.Px.b(), ((akgb) aX).w, ((akgb) aX).b.a.Uk, ((akgb) aX).x);
                    f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (!adhu.a() || !ctjd.c()) {
                ...
                cxgb cxgbVar = new cxgb();
                fbae.e(cxgbVar);
                cgVar.E(R.id.fragment_container, cxgbVar);
                cgVar.j();
            }
            this.M = false;
            this.L.m();
    ...
    public final boolean onCreateOptionsMenu(Menu menu) {
        ...
        final cxga M = M();
        M.a.getMenuInflater().inflate(R.menu.smarts_settings_fragment_menu, menu);
        MenuItem findItem = menu.findItem(R.id.action_learn_more);
        findItem.setVisible(true);
        findItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() { // from class: cxfy
            @Override // android.view.MenuItem.OnMenuItemClickListener
            public final boolean onMenuItemClick(MenuItem menuItem) {
                String str = (String) ctjd.t.e();
                cxga cxgaVar = cxga.this;
                cxgaVar.b.y(cxgaVar.a, str);
                return true;
            }
        });
        return true;
