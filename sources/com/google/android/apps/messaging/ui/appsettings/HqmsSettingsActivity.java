...
public final class HqmsSettingsActivity extends cwvy implements ekhu, ekhr, ekke {
    private cwxl K;
    private boolean M;
    private Context N;
    private lkv P;
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof HqmsSettingsActivity)) {
                        throw new IllegalStateException(a.I(activity, cwxl.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    ...
                    this.K = new cwxl(hqmsSettingsActivity, akkpVar.Px, ((akgb) aX).ba, akkpVar.au, ((akgb) aX).x, ((akgb) aX).w, akkpVar.as);
                    f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            final cwxl M = M();
            TextView textView = (TextView) M.a.findViewById(R.id.hqms_preference_fragment_container_text_view);
            SpannableStringBuilder d = ddyi.d(M.a, R.string.hqms_settings_info_text);
            textView.setText(d);
            textView.setContentDescription(d.toString());
            textView.setOnClickListener(new View.OnClickListener() { // from class: cwxg
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    cwxl cwxlVar = cwxl.this;
                    akvg akvgVar = (akvg) cwxlVar.b.b();
                    cfva cfvaVar = cjja.a;
                    akvgVar.y(cwxlVar.a, (String) cjja.e.e());
                }
            });
            this.M = false;
            this.L.m();
