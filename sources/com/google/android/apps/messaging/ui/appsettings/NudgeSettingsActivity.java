...
public final class NudgeSettingsActivity extends cwwa implements ekhu, ekhr, ekke {
    private cwya K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof NudgeSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, cwya.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        NudgeSettingsActivity nudgeSettingsActivity = (NudgeSettingsActivity) activity;
                        nudgeSettingsActivity.getClass();
                        this.K = new cwya(nudgeSettingsActivity);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cwyb cwybVar = new cwyb();
            fbae.e(cwybVar);
            cgVar.E(R.id.fragment_container, cwybVar);
            cgVar.j();
            this.M = false;
            this.L.m();
            t.close();
