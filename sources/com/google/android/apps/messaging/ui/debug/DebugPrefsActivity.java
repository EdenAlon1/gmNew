...
public final class DebugPrefsActivity extends davw implements ekhu, ekhr, ekke {
    private boolean A;
    private daen n;
    private boolean p;
    private Context q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof DebugPrefsActivity)) {
                            throw new IllegalStateException(a.I(activity, daen.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        DebugPrefsActivity debugPrefsActivity = (DebugPrefsActivity) activity;
                        debugPrefsActivity.getClass();
                        this.n = new daen(debugPrefsActivity);
                        f.close();
