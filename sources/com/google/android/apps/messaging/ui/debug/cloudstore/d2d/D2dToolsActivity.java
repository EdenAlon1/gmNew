...
public final class D2dToolsActivity extends dbej implements ekhu, ekhr, ekke {
    private boolean A;
    private dbdn n;
    private boolean p;
    private Context q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof D2dToolsActivity)) {
                            throw new IllegalStateException(a.I(activity, dbdn.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        D2dToolsActivity d2dToolsActivity = (D2dToolsActivity) activity;
                        d2dToolsActivity.getClass();
                        this.n = new dbdn(d2dToolsActivity);
                        f.close();
