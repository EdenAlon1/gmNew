...
public final class DebugMobileConfigurationActivity extends davt implements ekhu, ekhr, ekke {
    private boolean A;
    private daeh n;
    private boolean p;
    private Context q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof DebugMobileConfigurationActivity)) {
                            throw new IllegalStateException(a.I(activity, daeh.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.n = new daeh(debugMobileConfigurationActivity);
                        f.close();
