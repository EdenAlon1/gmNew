...
public final class KeyRetrievalClientActivity extends dbeq implements ekhu, ekhr, ekke {
    private boolean A;
    private dbes n;
    private boolean p;
    private Context q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof KeyRetrievalClientActivity)) {
                            throw new IllegalStateException(a.I(activity, dbes.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.n = new dbes(keyRetrievalClientActivity);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            dbet dbetVar = new dbet();
            fbae.e(dbetVar);
            cgVar.s(R.id.content, dbetVar);
            cgVar.c();
            this.p = false;
            this.o.m();
            t.close();
