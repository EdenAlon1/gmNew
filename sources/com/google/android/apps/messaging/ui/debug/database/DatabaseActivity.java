...
public final class DatabaseActivity extends dblo implements ekhu, ekhr, ekke {
    private boolean A;
    private dbjg n;
    private boolean p;
    private Context q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof DatabaseActivity)) {
                            throw new IllegalStateException(a.I(activity, dbjg.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        DatabaseActivity databaseActivity = (DatabaseActivity) activity;
                        databaseActivity.getClass();
                        this.n = new dbjg(databaseActivity);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (bundle == null) {
                ...
                dbjw dbjwVar = new dbjw();
                fbae.e(dbjwVar);
                cgVar.s(R.id.content, dbjwVar);
                cgVar.c();
            }
            this.p = false;
            this.o.m();
