...
public final class CmsSyncAnalysisActivity extends dbam implements ekhu, ekhr, ekke {
    private boolean A;
    private dazp n;
    private boolean p;
    private Context q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof CmsSyncAnalysisActivity)) {
                            throw new IllegalStateException(a.I(activity, dazp.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        CmsSyncAnalysisActivity cmsSyncAnalysisActivity = (CmsSyncAnalysisActivity) activity;
                        cmsSyncAnalysisActivity.getClass();
                        this.n = new dazp(cmsSyncAnalysisActivity);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            dazq dazqVar = new dazq();
            fbae.e(dazqVar);
            cgVar.s(R.id.content, dazqVar);
            cgVar.c();
            this.p = false;
            this.o.m();
            t.close();
