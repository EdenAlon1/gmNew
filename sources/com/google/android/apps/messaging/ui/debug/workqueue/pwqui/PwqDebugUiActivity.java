...
public final class PwqDebugUiActivity extends dbog implements ekhu, ekhr, ekke {
    private boolean A;
    private dboi n;
    private boolean p;
    private Context q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof PwqDebugUiActivity)) {
                            throw new IllegalStateException(a.I(activity, dboi.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        PwqDebugUiActivity pwqDebugUiActivity = (PwqDebugUiActivity) activity;
                        pwqDebugUiActivity.getClass();
                        this.n = new dboi(pwqDebugUiActivity);
                        f.close();
