...
public final class ConversationSuggestionStickerView extends czty {
    public static final cskc a = cskc.g("Bugle", "ConversationSuggestionStickerView");
    ...
    protected final void onFinishInflate() {
        ...
        this.d = new crly(this, R.id.sticker_debug_info_view_stub, R.id.sticker_debug_info_view);
        ...
        setForeground(resources.getDrawable(crlu.b(getContext(), android.R.attr.selectableItemBackground).resourceId, getContext().getTheme()));
        this.f = new Path();
