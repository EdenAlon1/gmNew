...
import defpackage.cyom;
import defpackage.eito;
import defpackage.ejgc;
...
public final class ConversationDetailsActivity extends cyom implements ekhu, ekhr, ekke {
    private boolean L;
    private Context M;
    private lkv O;
    private boolean P;
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof ConversationDetailsActivity)) {
                        throw new IllegalStateException(a.I(activity, cynq.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    ...
                    this.n = new cynq(conversationDetailsActivity, ((akgb) aX).bg, ((akgb) aX).bh, (eito) ((akgb) aX).w.b(), (ejgc) ((akgb) aX).b.a.Uk.b(), ((akgb) aX).b.b.kU);
                    f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cynq cynqVar = this.n;
            ellj.a(this, aijj.class, new cynr(cynqVar));
            ellj.a(this, aijd.class, new cyns(cynqVar));
            ellj.a(this, aimx.class, new cynt(cynqVar));
            ellj.a(this, aimy.class, new cynu(cynqVar));
            this.L = false;
            this.K.m();
            t.close();
        } catch (Throwable th) {
