...
public final class GalleryBrowserActivity extends dcgg implements ekhu, ekhr, ekke {
    private dcew K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof GalleryBrowserActivity)) {
                            throw new IllegalStateException(a.I(activity, dcew.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        GalleryBrowserActivity galleryBrowserActivity = (GalleryBrowserActivity) activity;
                        galleryBrowserActivity.getClass();
                        this.K = new dcew(galleryBrowserActivity, (eito) ((akgb) aX).w.b(), ((akgb) aX).x);
                        f.close();
                        this.K.c = this;
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            ellj.a(this, dceq.a.class, new dcex(this.K));
            this.M = false;
            this.L.m();
            t.close();
        } catch (Throwable th) {
    ...
    public final boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        try {
            dcew ah = ah();
            ActionMode actionMode = (ActionMode) ah.a.W().orElse(null);
            ActionMode.Callback V = ah.a.V();
            boolean onOptionsItemSelected = (actionMode == null || V == null || !V.onActionItemClicked(actionMode, menuItem)) ? super.onOptionsItemSelected(menuItem) : true;
            w.close();
