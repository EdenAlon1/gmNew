...
public final class BlockedParticipantsActivity extends sux implements ekhu, ekhr, ekke {
    private boolean H;
    private Context I;
    private lkv K;
    private boolean L;
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            suy suyVar = new suy();
            fbae.e(suyVar);
            cg cgVar = new cg(((BlockedParticipantsActivity) M.a.b()).a());
            cgVar.s(R.id.content, suyVar);
            cgVar.c();
            im k = ((BlockedParticipantsActivity) M.a.b()).k();
            if (k != null) {
                k.setDisplayHomeAsUpEnabled(true);
                k.setTitle(com.google.android.apps.messaging.R.string.blocked_destination_list_title);
            }
            this.H = false;
            this.G.m();
            t.close();
    ...
    public final boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        try {
            ...
            if (menuItem.getItemId() != 16908332) {
                ...
                ((BlockedParticipantsActivity) M.a.b()).gE().d();
                z = true;
            }
            w.close();
            return z;
