...
public final class SmartActionSettingsActivity extends cwlb implements ekhu, ekhr, ekke {
    private cwld K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof SmartActionSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, cwld.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.K = new cwld(smartActionSettingsActivity);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cwle cwleVar = new cwle();
            fbae.e(cwleVar);
            cgVar.E(R.id.fragment_container, cwleVar);
            cgVar.c();
            this.M = false;
            this.L.m();
            t.close();
