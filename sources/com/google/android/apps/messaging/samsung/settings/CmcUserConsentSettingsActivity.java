package com.google.android.apps.messaging.samsung.settings;
...
public final class CmcUserConsentSettingsActivity extends akos implements ekhu, ekhr, ekke {
    private akof K;
    private boolean M;
    private Context N;
    private lkv P;
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            fbae.e(akonVar);
            cgVar.E(R.id.fragment_container, akonVar);
            cgVar.j();
            this.M = false;
            this.L.m();
            t.close();
