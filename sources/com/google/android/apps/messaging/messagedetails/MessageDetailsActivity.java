...
public final class MessageDetailsActivity extends ahse implements ekhu, ekhr, ekke {
    private boolean L;
    private Context M;
    private lkv O;
    private boolean P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof MessageDetailsActivity)) {
                            throw new IllegalStateException(a.I(activity, ahsg.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        MessageDetailsActivity messageDetailsActivity = (MessageDetailsActivity) activity;
                        messageDetailsActivity.getClass();
                        this.n = new ahsg(messageDetailsActivity, (eito) ((akgb) aX).w.b(), (ejgc) ((akgb) aX).b.a.Uk.b());
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            ellj.a(this, aijd.class, new ahsh(this.n));
            this.L = false;
            this.K.m();
            t.close();
        } catch (Throwable th) {
