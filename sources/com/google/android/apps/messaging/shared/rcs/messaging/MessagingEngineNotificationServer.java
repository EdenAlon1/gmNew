...
public final class MessagingEngineNotificationServer extends clft implements ekhu<clgr> {
    public ekqj a;
    private clgr b;
    private boolean c;
    ...
    @Override // defpackage.clft, defpackage.lkx, android.app.Service
            ...
            if (this.b == null) {
                ...
                try {
                    ...
                    try {
                        try {
                            Object aX = aX();
                            this.b = new clgr((Context) ((akhb) aX).b.q.b(), (evgy) ((akhb) aX).d.b());
                            f.close();
