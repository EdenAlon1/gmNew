...
public final class PenpalBotConversationId implements ConversationId {
    public static final Parcelable.Creator<ConversationId> CREATOR = new amvr();
    ...
    public static PenpalBotConversationId d(String str) {
        return new PenpalBotConversationId(bdgq.b(str));
    }

    @Override // com.google.android.apps.messaging.shared.api.messaging.conversation.ConversationId
    public final amwk a() {
        return amwk.PENPAL_BOT;
    }
