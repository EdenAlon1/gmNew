...
public final class NotificationSettingsActivity extends aipw implements ekhu, ekhr, ekke {
    private aipy K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof NotificationSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, aipy.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.K = new aipy(notificationSettingsActivity);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            fbae.e(aipzVar);
            cgVar.E(R.id.notification_preference_fragment_container, aipzVar);
            cgVar.c();
            this.M = false;
            this.L.m();
            t.close();
