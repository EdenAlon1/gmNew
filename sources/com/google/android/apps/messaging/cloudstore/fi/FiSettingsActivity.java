...
public final class FiSettingsActivity extends tim implements ekhu, ekhr, ekke {
    private thd K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof FiSettingsActivity)) {
                            throw new IllegalStateException(a.I(activity, thd.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        FiSettingsActivity fiSettingsActivity = (FiSettingsActivity) activity;
                        fiSettingsActivity.getClass();
                        this.K = new thd(fiSettingsActivity, (eito) ((akgb) aX).w.b(), (akzt) ((akgb) aX).b.a.f.b());
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            ellj.a(this, tii.class, new the(this.K));
            this.M = false;
            this.L.m();
            t.close();
        } catch (Throwable th) {
