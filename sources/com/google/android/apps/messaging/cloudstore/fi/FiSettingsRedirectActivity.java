...
public final class FiSettingsRedirectActivity extends tio implements ekhu, ekhr, ekke {
    private thy K;
    private boolean M;
    private Context N;
    private lkv P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof FiSettingsRedirectActivity)) {
                            throw new IllegalStateException(a.I(activity, thy.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.K = new thy(fiSettingsRedirectActivity, ((akgb) aX).x, ((akgb) aX).w);
                        f.close();
