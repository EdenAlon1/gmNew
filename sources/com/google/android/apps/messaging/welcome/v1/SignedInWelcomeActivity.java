...
import defpackage.deir;
import defpackage.deit;
import defpackage.deiu;
...
public final class SignedInWelcomeActivity extends deir implements ekhu, ekhr, ekke {
    private boolean A;
    private deiu n;
    private boolean p;
    private Context q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof SignedInWelcomeActivity)) {
                            throw new IllegalStateException(a.I(activity, deiu.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        SignedInWelcomeActivity signedInWelcomeActivity = (SignedInWelcomeActivity) activity;
                        signedInWelcomeActivity.getClass();
                        this.n = new deiu(fbbfVar, signedInWelcomeActivity, ((akgb) aX).x, ((akgb) aX).b.a.RR);
                        f.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            intent.getClass();
            if (dejo.a(intent) != cvjl.WELCOME_FLOW_SETTINGS) {
                J.a.gE().a(new deit(J));
            }
            this.p = false;
            this.o.m();
