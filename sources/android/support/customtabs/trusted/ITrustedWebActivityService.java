...
public interface ITrustedWebActivityService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITrustedWebActivityService {
        ...
        public static ITrustedWebActivityService asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ITrustedWebActivityService)) ? new by(iBinder) : (ITrustedWebActivityService) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                case 2:
                    Bundle notifyNotificationWithChannel = notifyNotificationWithChannel((Bundle) bz.a(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    bz.b(parcel2, notifyNotificationWithChannel, 1);
                    return true;
                case 3:
                ...
                case 5:
                    ...
                    return true;
                case 6:
                    Bundle areNotificationsEnabled = areNotificationsEnabled((Bundle) bz.a(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
                    bz.b(parcel2, areNotificationsEnabled, 1);
                    return true;
                case 7:
                ...
                case 9:
                    Bundle extraCommand = extraCommand(parcel.readString(), (Bundle) bz.a(parcel, Bundle.CREATOR), parcel.readStrongBinder());
                    parcel2.writeNoException();
                    bz.b(parcel2, extraCommand, 1);
                    return true;
            }
        }
