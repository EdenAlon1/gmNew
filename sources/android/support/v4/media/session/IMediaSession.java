...
public interface IMediaSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        public static IMediaSession asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMediaSession)) ? new hu(iBinder) : (IMediaSession) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                case 1:
                    ...
                    return true;
                case 2:
                    boolean sendMediaButton = sendMediaButton((KeyEvent) hv.a(parcel, KeyEvent.CREATOR));
                    parcel2.writeNoException();
