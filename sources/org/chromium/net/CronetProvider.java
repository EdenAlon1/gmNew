...
public abstract class CronetProvider {
    ...
    private static boolean addCronetProviderFromResourceFile(Context context, fihz fihzVar, Set<fifh> set) {
        ...
        if (string != null && !string.equals(PLAY_SERVICES_CRONET_PROVIDER_CLASS) && !string.equals(GMS_CORE_CRONET_PROVIDER_CLASS) && !string.equals(JAVA_CRONET_PROVIDER_CLASS) && !string.equals(NATIVE_CRONET_PROVIDER_CLASS)) {
            z = true;
            if (!addCronetProviderImplByClassName(context, string, fihzVar, set, true)) {
    ...
    private static boolean addCronetProviderImplByClassName(Context context, String str, fihz fihzVar, Set<fifh> set, boolean z) {
        try {
            ...
            fifh fifhVar = new fifh();
            fifhVar.a = (CronetProvider) constructor.newInstance(context);
            fifhVar.b = fihzVar;
            set.add(fifhVar);
            return true;
    ...
    static List<fifh> getAllProviderInfos(Context context) {
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        addCronetProviderFromResourceFile(context, fihz.CRONET_SOURCE_UNSPECIFIED, linkedHashSet);
        addCronetProviderImplByClassName(context, PLAY_SERVICES_CRONET_PROVIDER_CLASS, fihz.CRONET_SOURCE_PLAY_SERVICES, linkedHashSet, false);
        addCronetProviderImplByClassName(context, GMS_CORE_CRONET_PROVIDER_CLASS, fihz.CRONET_SOURCE_PLAY_SERVICES, linkedHashSet, false);
        addCronetProviderImplByClassName(context, NATIVE_CRONET_PROVIDER_CLASS, fihz.CRONET_SOURCE_STATICALLY_LINKED, linkedHashSet, false);
        addCronetProviderImplByClassName(context, JAVA_CRONET_PROVIDER_CLASS, fihz.CRONET_SOURCE_FALLBACK, linkedHashSet, false);
    ...
    public static List<CronetProvider> getAllProviders(Context context) {
        ...
        Iterator<fifh> it = getAllProviderInfos(context).iterator();
        while (it.hasNext()) {
