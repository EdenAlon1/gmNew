...
import defpackage.fifj;
import defpackage.fihx;
...
public abstract class CronetEngine {
    ...
    public static class Builder {
        ...
        private final List<fifi> mExperimentalOptionsPatches;
        ...
        private static ICronetEngineBuilder createBuilderDelegate(Context context) {
            new fiev("CronetEngine#createBuilderDelegate");
            try {
                ...
                fifh fifhVar = (fifh) arrayList.get(0);
                fiic a = fiid.a(context, fifhVar.b);
                ...
                try {
                    ...
                    if (Log.isLoggable(TAG, 3)) {
                        Log.d(TAG, String.format("Using '%s' provider for creating CronetEngine.Builder.", fifhVar.a));
                    }
                    ICronetEngineBuilder iCronetEngineBuilder = fifhVar.a.createBuilder().mBuilderDelegate;
                    String implCronetVersion = getImplCronetVersion(iCronetEngineBuilder);
                    if (implCronetVersion != null) {
                        fihxVar.f = new fiib(implCronetVersion);
                    }
                    fihxVar.a = iCronetEngineBuilder.getLogCronetInitializationRef();
                    fihxVar.d = true;
                    Trace.endSection();
                    return iCronetEngineBuilder;
                } finally {
                    fihxVar.b = (int) (SystemClock.uptimeMillis() - uptimeMillis);
                    a.b(fihxVar);
                }
            } catch (Throwable th) {
                try {
        ...
        static List<fifh> getEnabledCronetProviders(Context context, List<fifh> list) {
            if (list.isEmpty()) {
                throw new RuntimeException("Unable to find any Cronet provider. Have you included all necessary jars?");
            }
            Iterator<fifh> it = list.iterator();
            while (it.hasNext()) {
            ...
            Collections.sort(list, new fifg());
            return list;
        }
        ...
        private static Method getImplVersionMethod(ICronetEngineBuilder iCronetEngineBuilder, String str) {
            try {
                return iCronetEngineBuilder.getClass().getClassLoader().loadClass("org.chromium.net.impl.ImplVersion").getMethod(str, new Class[0]);
        ...
        static /* synthetic */ void lambda$setConnectionMigrationOptions$2(ConnectionMigrationOptions connectionMigrationOptions, JSONObject jSONObject) {
            JSONObject a = fifj.a(jSONObject, "QUIC");
        ...
        static /* synthetic */ void lambda$setDnsOptions$1(DnsOptions dnsOptions, JSONObject jSONObject) {
            ...
            JSONObject a3 = fifj.a(jSONObject, "QUIC");
        ...
        static /* synthetic */ void lambda$setQuicOptions$0(QuicOptions quicOptions, JSONObject jSONObject) {
            ...
            if (!quicOptions.getQuicHostAllowlist().isEmpty()) {
                a.put("host_whitelist", ExperimentalOptionsTranslator$$ExternalSyntheticBackport0.m(",", quicOptions.getQuicHostAllowlist()));
            }
            if (!quicOptions.getEnabledQuicVersions().isEmpty()) {
                a.put("quic_version", ExperimentalOptionsTranslator$$ExternalSyntheticBackport0.m(",", quicOptions.getEnabledQuicVersions()));
            }
            if (!quicOptions.getConnectionOptions().isEmpty()) {
                a.put("connection_options", ExperimentalOptionsTranslator$$ExternalSyntheticBackport0.m(",", quicOptions.getConnectionOptions()));
            }
            if (!quicOptions.getClientConnectionOptions().isEmpty()) {
                a.put("client_connection_options", ExperimentalOptionsTranslator$$ExternalSyntheticBackport0.m(",", quicOptions.getClientConnectionOptions()));
            }
            if (!quicOptions.getExtraQuicheFlags().isEmpty()) {
                a.put("set_quic_flags", ExperimentalOptionsTranslator$$ExternalSyntheticBackport0.m(",", quicOptions.getExtraQuicheFlags()));
            }
        ...
        private void maybeSetExperimentalOptions() {
            ...
            List<fifi> list = this.mExperimentalOptionsPatches;
            ...
            if (jSONObject2 == null && list.isEmpty()) {
                ...
                Iterator<fifi> it = list.iterator();
                while (it.hasNext()) {
                    try {
        ...
        public Builder setConnectionMigrationOptions(final ConnectionMigrationOptions connectionMigrationOptions) {
            ...
            this.mExperimentalOptionsPatches.add(new fifi() { // from class: org.chromium.net.CronetEngine$Builder$$ExternalSyntheticLambda1
                @Override // defpackage.fifi
        ...
        public Builder setDnsOptions(final DnsOptions dnsOptions) {
            ...
            this.mExperimentalOptionsPatches.add(new fifi() { // from class: org.chromium.net.CronetEngine$Builder$$ExternalSyntheticLambda2
                @Override // defpackage.fifi
                public final void applyTo(JSONObject jSONObject) {
        ...
        public Builder setQuicOptions(final QuicOptions quicOptions) {
            ...
            this.mExperimentalOptionsPatches.add(new fifi() { // from class: org.chromium.net.CronetEngine$Builder$$ExternalSyntheticLambda0
                @Override // defpackage.fifi
                public final void applyTo(JSONObject jSONObject) {
