...
public class TBSCertificate extends ASN1Object {
    ...
    private TBSCertificate(ASN1Sequence aSN1Sequence) {
        ...
        int e = (aSN1Sequence.e() - i2) - 1;
        if (e != 0 && z) {
            throw new IllegalArgumentException("version 1 certificate contains extra data");
        }
        while (e > 0) {
            ASN1TaggedObject aSN1TaggedObject = (ASN1TaggedObject) aSN1Sequence.h(i2 + e);
            ...
            if (i3 == 1) {
                ...
                if (i3 != 3) {
                    throw new IllegalArgumentException(a.h(i3, "Unknown tag encountered in structure: "));
                }
                if (z2) {
    ...
    public final ASN1Primitive p() {
        if (ficz.a("org.bouncycastle.x509.allow_non-der_tbscert") == null || ficz.b("org.bouncycastle.x509.allow_non-der_tbscert")) {
            return this.a;
        }
