...
public abstract class ASN1BitString extends ASN1Primitive implements ASN1String, ASN1BitStringParser {
    static final ASN1UniversalType a = new ASN1UniversalType(ASN1BitString.class) { // from class: org.bouncycastle.asn1.ASN1BitString.1
    ...
    static ASN1BitString h(byte[] bArr) {
        ...
        if (i > 0) {
            ...
            if (b != ((byte) ((PrivateKeyType.INVALID << i) & b))) {
    ...
    public static ASN1BitString i(Object obj) {
        ...
        if (obj instanceof ASN1Encodable) {
            ...
            if (p instanceof ASN1BitString) {
                return (ASN1BitString) p;
            }
    ...
    public final boolean c(ASN1Primitive aSN1Primitive) {
        ...
        int i3 = bArr[0] & 255;
        byte b = bArr[i];
        int i4 = PrivateKeyType.INVALID << i3;
    ...
    public final int hashCode() {
        ...
        int i = 0;
        int i2 = length - 1;
        int i3 = (PrivateKeyType.INVALID << (bArr[0] & 255)) & bArr[i2];
        if (bArr != null) {
            while (true) {
                i2--;
                if (i2 < 0) {
    ...
    public final byte[] m() {
        ...
        int i = bArr[0] & 255;
        byte[] g = fics.g(bArr, 1, length);
        int length2 = g.length - 1;
        g[length2] = (byte) (g[length2] & ((byte) (PrivateKeyType.INVALID << i)));
        return g;
    }
    ...
    public final byte[] n() {
        byte[] bArr = this.b;
        if (bArr[0] == 0) {
            return fics.g(bArr, 1, bArr.length);
        }
