...
public final class n extends AbstractC0022a implements Serializable {
    ...
    static {
        n nVar = new n();
        n = nVar;
        AbstractC0022a.G(nVar, "Hijrah");
        AbstractC0022a.G(nVar, "islamic");
    }
    ...
    private void d0() {
        ...
        try {
            ...
            this.i = 15600;
            this.g = epochDay;
            int[] f0 = f0(epochDay, hashMap);
            this.f = f0;
            this.h = f0[3612];
            for (int i2 = 1300; i2 < 1600; i2++) {
                int n0 = n0(i2, 12);
                this.l = Math.min(this.l, n0);
                this.m = Math.max(this.m, n0);
            }
            this.e = true;
        } catch (Exception e) {
    ...
    private int[] f0(int i, HashMap hashMap) {
    ...
    public final j$.time.temporal.o Q(ChronoField chronoField) {
        ...
        switch (m.a[chronoField.ordinal()]) {
            case 1:
                return j$.time.temporal.o.k(1L, this.j, this.k);
            case 2:
                return j$.time.temporal.o.j(1L, this.m);
            case 3:
                return j$.time.temporal.o.j(1L, 5L);
            case 4:
            case 5:
                return j$.time.temporal.o.j(g0(0), g0(this.f.length - 1) - 1);
            case 6:
                return j$.time.temporal.o.j(1L, 1L);
            default:
                return chronoField.o();
        }
    }
    ...
    @Override // j$.time.chrono.Chronology
    public final List T() {
        return j$.desugar.sun.nio.fs.g.b(q.values());
    }

    @Override // j$.time.chrono.Chronology
    public final boolean V(long j) {
        d0();
        return j >= ((long) g0(0)) && j <= ((long) (g0(this.f.length - 1) - 1)) && n0((int) j, 12) > 354;
    }
    ...
    final int e0(long j) {
        if (j >= g0(0) && j <= g0(this.f.length - 1) - 1) {
            return (int) j;
        }
    ...
    final int[] j0(int i) {
        ...
        return new int[]{g0(binarySearch), ((this.i + binarySearch) % 12) + 1, (i - this.f[binarySearch]) + 1};
    }

    final int k0(int i, int i2) {
        int i3 = (i2 - 1) + ((i * 12) - this.i);
        if (i3 >= 0) {
            int[] iArr = this.f;
            if (i3 < iArr.length) {
    ...
    public final ChronoLocalDate r(TemporalAccessor temporalAccessor) {
        return temporalAccessor instanceof p ? (p) temporalAccessor : p.g0(this, temporalAccessor.y(ChronoField.EPOCH_DAY));
    }

    @Override // j$.time.chrono.AbstractC0022a
    public final ChronoLocalDate u() {
        return p.g0(this, LocalDate.i0(j$.time.b.g()).y(ChronoField.EPOCH_DAY));
    }
