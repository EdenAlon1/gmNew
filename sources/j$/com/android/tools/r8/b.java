...
public final /* synthetic */ class b {
    ...
    public final /* synthetic */ void c(Object obj, Object obj2) {
        ...
        if (cls == cls2) {
            ...
            Class cls4 = this.b;
            if (cls4 == cls3) {
                this.a.putInt(obj, this.c, e);
                return;
            } else if (cls4 == Long.TYPE) {
                this.a.putLong(obj, this.c, e);
                return;
            } else {
                c(obj, Integer.valueOf(e));
                return;
            }
        }
        long j = this.c;
        ...
        long f = f(obj2);
        if (cls == cls5) {
            this.a.putLong(obj, this.c, f);
        } else {
            if (cls == cls2) {
                throw new RuntimeException("java.lang.invoke.WrongMethodTypeException");
            }
            this.a.putObject(obj, j, Long.valueOf(f));
        }
    }
    ...
    public final /* synthetic */ void d(Object obj, Object obj2) {
        ...
        if (cls == cls2) {
            ...
            Class cls4 = this.b;
            if (cls4 == cls3) {
                this.a.putOrderedInt(obj, this.c, e);
                return;
            } else if (cls4 == Long.TYPE) {
                this.a.putOrderedLong(obj, this.c, e);
                return;
            } else {
                d(obj, Integer.valueOf(e));
                return;
            }
        }
        long j = this.c;
        ...
        long f = f(obj2);
        if (cls == cls5) {
            this.a.putOrderedLong(obj, this.c, f);
        } else {
            if (cls == cls2) {
                throw new RuntimeException("java.lang.invoke.WrongMethodTypeException");
            }
            this.a.putOrderedObject(obj, j, Long.valueOf(f));
        }
    }
