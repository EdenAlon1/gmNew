...
final class f4 extends AbstractC0076e0 {
    final /* synthetic */ IntPredicate m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    f4(AbstractC0081f0 abstractC0081f0, int i, IntPredicate intPredicate) {
    ...
    final Spliterator K(AbstractC0060b abstractC0060b, Spliterator spliterator) {
        return EnumC0124n3.ORDERED.y(abstractC0060b.F()) ? J(abstractC0060b, spliterator, new W(29)).spliterator() : new o4((Spliterator.OfInt) abstractC0060b.S(spliterator), this.m);
    }

    @Override // j$.util.stream.AbstractC0060b
    final InterfaceC0157u2 M(int i, InterfaceC0157u2 interfaceC0157u2) {
        return new e4(this, interfaceC0157u2);
    }
}
