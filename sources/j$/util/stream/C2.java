...
final class C2 extends A {
    ...
    final K0 J(AbstractC0060b abstractC0060b, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (B > 0 && spliterator.hasCharacteristics(16384)) {
            return AbstractC0175y0.C(abstractC0060b, F2.c(abstractC0060b.E(), spliterator, this.m, this.n), true);
        }
        if (EnumC0124n3.ORDERED.y(abstractC0060b.F())) {
            invoke = new E2(this, abstractC0060b, spliterator, intFunction, this.m, this.n).invoke();
            return (K0) invoke;
        }
        j$.util.V v = (j$.util.V) abstractC0060b.S(spliterator);
        long j3 = this.m;
        long j4 = this.n;
        if (j3 <= B) {
            long j5 = B - j3;
        ...
        return AbstractC0175y0.C(this, new K3(v, j2, j), true);
    }
    ...
    final Spliterator K(AbstractC0060b abstractC0060b, Spliterator spliterator) {
        ...
        if (B > 0 && spliterator.hasCharacteristics(16384)) {
            j$.util.V v = (j$.util.V) abstractC0060b.S(spliterator);
            long j2 = this.m;
            return new E3(v, j2, F2.b(j2, j));
        }
        if (EnumC0124n3.ORDERED.y(abstractC0060b.F())) {
            invoke = new E2(this, abstractC0060b, spliterator, new W(26), this.m, this.n).invoke();
            return ((K0) invoke).spliterator();
        }
        j$.util.V v2 = (j$.util.V) abstractC0060b.S(spliterator);
        long j3 = this.m;
        if (j3 <= B) {
            long j4 = B - j3;
            if (j >= 0) {
