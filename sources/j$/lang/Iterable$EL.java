...
public final /* synthetic */ class Iterable$EL {
    ...
    public static Spliterator spliterator(Iterable iterable) {
        ...
        if (!(iterable instanceof Set)) {
            return iterable instanceof List ? List.CC.$default$spliterator((java.util.List) iterable) : iterable instanceof Collection ? Collection.CC.$default$spliterator((java.util.Collection) iterable) : Spliterators.spliteratorUnknownSize(iterable.iterator(), 0);
        }
