...
public interface IMultiInstanceInvalidationService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMultiInstanceInvalidationService {
        ...
        public static IMultiInstanceInvalidationService asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMultiInstanceInvalidationService)) ? new orw(iBinder) : (IMultiInstanceInvalidationService) queryLocalInterface;
        }
