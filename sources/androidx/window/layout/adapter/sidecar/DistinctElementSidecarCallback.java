...
public class DistinctElementSidecarCallback implements SidecarInterface.SidecarCallback {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x001a, code lost:
        ...
        if (defpackage.pmu.a(r1) == defpackage.pmu.a(r4)) goto L13;
     */
    /*
    ...
    */
    public void onDeviceStateChanged(androidx.window.sidecar.SidecarDeviceState r4) {
        ...
        L3:
            ...
            boolean r2 = defpackage.ffkj.e(r1, r4)     // Catch: java.lang.Throwable -> L27
            if (r2 == 0) goto Lf
            goto L1c
        Lf:
            if (r1 != 0) goto L12
            goto L1e
        L12:
            int r1 = defpackage.pmu.a(r1)     // Catch: java.lang.Throwable -> L27
            int r2 = defpackage.pmu.a(r4)     // Catch: java.lang.Throwable -> L27
            if (r1 != r2) goto L1e
        L1c:
    ...
    public void onWindowLayoutChanged(IBinder iBinder, SidecarWindowLayoutInfo sidecarWindowLayoutInfo) {
        synchronized (this.a) {
            ...
            if (!ffkj.e(sidecarWindowLayoutInfo2, sidecarWindowLayoutInfo)) {
                if (sidecarWindowLayoutInfo2 != null && sidecarWindowLayoutInfo != null) {
                    List b = pmu.b(sidecarWindowLayoutInfo2);
                    List b2 = pmu.b(sidecarWindowLayoutInfo);
                    if (b != b2) {
                        if (b.size() == b2.size()) {
                            int size = b.size();
                            for (int i = 0; i < size; i++) {
                                SidecarDisplayFeature sidecarDisplayFeature = (SidecarDisplayFeature) b.get(i);
                                SidecarDisplayFeature sidecarDisplayFeature2 = (SidecarDisplayFeature) b2.get(i);
                                if (!ffkj.e(sidecarDisplayFeature, sidecarDisplayFeature2)) {
                                    if (sidecarDisplayFeature != null && sidecarDisplayFeature2 != null && sidecarDisplayFeature.getType() == sidecarDisplayFeature2.getType() && ffkj.e(sidecarDisplayFeature.getRect(), sidecarDisplayFeature2.getRect())) {
                                    }
                                }
                            }
                        }
